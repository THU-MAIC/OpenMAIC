...
- AC-13: Given mục «Máy của tôi» trên màn Cài đặt, When người đi qua luồng lấy mã rồi luồng nhập mã, Then TÁM trạng thái dựng được mà không cần cơ sở dữ liệu đều có một khung chụp sống — `-tat`, `-san-sang`, `-co-ma`, `-ma-het-han`, `-dang-nhan`, `-nhan-loi`, `-se-ghi-de`, `-may-chu-im`; thiếu khung nào là đỏ.
- AC-17: Given trạng thái `-xong` và kết quả thật của việc nhận chỉ dựng được khi có cơ sở dữ liệu, When môi trường đo không có, Then người ký tự soi trên bản chạy và ghi điều mình thấy — máy KHÔNG được tự khai là đã chứng. (judgment)
...
- [THU PHẠM VI 21/09] Phép đo giao diện trước đây đòi chín khung từ một lần chạy sống. Máy đo không có cơ sở dữ liệu nào, nên trạng thái «đã dùng chung» và kết quả thật của việc nhận KHÔNG dựng được — thước đòi thứ môi trường không cấp. Nay tách đôi: máy chứng tám trạng thái dựng được (AC-13), mắt người ký chứng phần còn lại (AC-17). Thu đúng chỗ thiếu, không thu rộng hơn — ba giới hạn đã biết ở mục Known limits vẫn nguyên, không cái nào được xoá bằng lần thu này.
...
Người ký chấp nhận, 2026-09-21 — chi tiết và kịch bản ở `evidence-report.md`:

- Nhận xong mà màn báo «máy chủ im», không thử lại được vì mã một lần đã cháy.
- Lựa chọn cũ của máy này có thể ghi đè cấu hình máy kia sau khi nhận.
- Đổi mã chốt danh tính trước khi biết nạp lại có xong không.
- Luồng đầu-cuối chưa chạy trọn lần nào: máy đo không có cơ sở dữ liệu.
