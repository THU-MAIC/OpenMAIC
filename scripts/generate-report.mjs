...
slide3.addText(
  '由清华大学团队开发的 AI 生成式课件系统，支持从教材、PDF 等文档自动生成交互式课堂。',
  {
    x: 0.5,
    y: 2.1,
    w: 9,
...
slide3.addText(
  '在原有仅支持 PDF 的基础上，新增 TXT 和 DOCX 两种常见文档格式的支持，提升系统易用性。',
  {
    x: 0.5,
    y: 3.8,
    w: 9,
...
const formats = ['✓ PDF（原有功能，保留）', '✓ TXT（新增）', '✓ DOCX（新增）'];
formats.forEach((f, i) => {
...
slide8.addText(
  '当 AI 生成的大纲数量超过约10个时，会出现重复的 scene_3 等 ID，导致 React 渲染警告。',
  {
    x: 0.5,
    y: 2.1,
    w: 9,
...
slide10.addText(
  'lib/document-parser.ts (+104), components/generation/*.tsx (+32), API路由 (+43), i18n文件 (+14×6)',
  {
    x: 0.5,
    y: 4.8,
    w: 9,
