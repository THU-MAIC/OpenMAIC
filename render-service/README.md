...
| Method + path                 | Purpose                                                                              |
| ----------------------------- | ------------------------------------------------------------------------------------ |
| `POST /preview`               | render one persisted scene to PNG with layout diagnostics in the response header    |
...
| `RENDER_PREVIEW_TIMEOUT_MS`               | `20000`                     | Hard wall-clock deadline for a synchronous `POST /preview` request.                                                                                                                                                                                                                                                                                                 |
| `RENDER_PREVIEW_MAX_IN_FLIGHT`            | `8`                         | Total preview requests admitted at once across buffering, queueing, and Chromium execution.                                                                                                                                                                                                                                                                        |
| `RENDER_PREVIEW_MAX_PER_USER`             | `2`                         | Concurrent previews admitted per `x-openmaic-client` identity; `0` disables this per-user guard.                                                                                                                                                                                                                                                                    |
