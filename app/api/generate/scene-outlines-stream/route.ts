...
export async function POST(req: NextRequest) {
  try {
    ...
    const { requirements, pdfText, pdfImages, imageMapping, researchContext, questionBankContext, agents } = body as {
    ...
    const prompts = buildPrompt(PROMPT_IDS.REQUIREMENTS_TO_OUTLINES, {
      ...
      questionBankContext: questionBankContext || (requirements.language === 'zh-CN' ? '无' : 'None'),
      mediaGenerationPolicy,
      teacherContext,
    });
