      ...
      {!open && (
        ...
        >
          <div className="shrink-0 relative">
            <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-border/30 group-hover:ring-amber-400/60 dark:group-hover:ring-amber-400/40 transition-all duration-300">
          ...
          >
            <div className="rounded-2xl bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-[0_1px_8px_-2px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_8px_-2px_rgba(0,0,0,0.3)] px-2.5 py-2">
              ...
              >
                ...
                >
                  <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-amber-300/70 dark:ring-amber-500/40 transition-all duration-300">
                    <img src={avatar} alt="" className="size-full object-cover" />
                  </div>
                  <motion.div
                    initial={{ scale: 0 }}
                ...
                <div className="flex-1 min-w-0">
                  {editingName ? (
                    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        onClick={commitName}
                        className="shrink-0 size-5 rounded flex items-center justify-center text-amber-500 hover:bg-amber-100 dark:hover:bg-amber-900/30"
                      >
                        ...
                        {AVATAR_OPTIONS.map((url) => (
                          <button
                            ...
                            className={cn(
                              ...
                              avatar === url
                                ? 'ring-2 ring-amber-400 dark:ring-amber-500 ring-offset-0'
                        ...
                        <label
                          className={cn(
                            ...
                            isCustomAvatar(avatar)
                              ? 'ring-2 ring-amber-400 dark:ring-amber-500 ring-offset-0 border-amber-300 dark:border-amber-600 bg-amber-50 dark:bg-amber-900/30'
  ...
  return (
    <div className="group cursor-pointer" onClick={confirmingDelete ? undefined : onClick}>
      ...
      >
        {slide && thumbWidth > 0 ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="size-12 rounded-2xl bg-gradient-to-br from-amber-100 to-blue-100 dark:from-amber-900/30 dark:to-blue-900/30 flex items-center justify-center">
      ...
      <div className="mt-2.5 px-1 flex items-center gap-2">
        <span className="shrink-0 inline-flex items-center rounded-full bg-amber-100 dark:bg-amber-900/30 px-2 py-0.5 text-[11px] font-medium text-amber-600 dark:text-amber-400">
        ...
        {editing ? (
          <div className="flex-1 min-w-0" onClick={(e) => e.stopPropagation()}>
            <input
              ...
              className="w-full bg-transparent border-b border-amber-400/60 text-[15px] font-medium text-foreground/90 outline-none placeholder:text-muted-foreground/40"
            />
          </div>
        ) : (
          <Tooltip>
