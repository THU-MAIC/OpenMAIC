...
import { PRICING_PLANS, PLAN_LIMITS, LIFETIME_MAX_SLOTS } from '@/lib/stripe/plans';
...
export default function PricingPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/lifetime-slots')
      .then(r => r.json())
      .then(j => { if (j.slots) setSlots(j.slots); })
      .catch(() => {});
  }, []);
  ...
  const slotsLeft = lifetimeSlots
    ? lifetimeSlots.max - lifetimeSlots.taken
    : LIFETIME_MAX_SLOTS;
            ...
            <div className="flex-1">
              ...
              <ul className="space-y-1.5 mb-4">
                ...
                <li className="flex items-center gap-2 text-sm text-[#073b4c]/70">
                  ...
                  <span><strong>1-on-1 support</strong> from the team</span>
                </li>
              </ul>
        ...
        <div className="rounded-3xl border-[3px] border-[#073b4c]/10 bg-white overflow-hidden">
          ...
          {FEATURES.map((f, i) => (
            ...
            >
              ...
              <div className="flex justify-center"><FeatureCheck value={f.free} /></div>
              <div className="flex justify-center"><FeatureCheck value={f.plus} /></div>
