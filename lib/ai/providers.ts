...
export const PROVIDERS: Record<ProviderId, ProviderConfig> = {
  ...
  pollinations: {
    ...
    requiresApiKey: true,
    icon: '/logos/pollinations.png',
    models: [
      {
        id: 'openai',
        name: 'OpenAI (via Pollinations)',
        contextWindow: 128000,
        outputWindow: 16384,
        capabilities: { streaming: true, tools: true, vision: true },
      },
      {
        id: 'openai-large',
        name: 'OpenAI Large (via Pollinations)',
        contextWindow: 128000,
        outputWindow: 16384,
        capabilities: { streaming: true, tools: true, vision: true },
      },
      {
        id: 'openai-reasoning',
        name: 'OpenAI Reasoning (via Pollinations)',
        contextWindow: 128000,
        outputWindow: 32768,
      ...
      {
        id: 'anthropic',
        name: 'Anthropic (via Pollinations)',
        contextWindow: 200000,
        outputWindow: 8192,
        capabilities: { streaming: true, tools: true, vision: true },
      },
      ...
      {
        id: 'gemini-large',
        name: 'Gemini Large (via Pollinations)',
        contextWindow: 1000000,
        outputWindow: 8192,
        capabilities: { streaming: true, tools: true, vision: true },
      },
      {
        id: 'gemini-search',
        name: 'Gemini Search (via Pollinations)',
        contextWindow: 1000000,
        outputWindow: 8192,
        capabilities: { streaming: true, tools: true, vision: true },
      },
      {
        id: 'deepseek',
        name: 'DeepSeek (via Pollinations)',
        contextWindow: 64000,
        outputWindow: 8192,
        capabilities: { streaming: true, tools: true, vision: false },
      },
      {
        id: 'deepseek-r1',
        name: 'DeepSeek R1 (via Pollinations)',
        contextWindow: 64000,
        outputWindow: 8192,
        capabilities: { streaming: true, tools: false, vision: false },
      },
