export const commonZhCN = {
  ...
  toolbar: {
    ...
    questionBank: '题库参考',
    questionBankHint: '上传或粘贴参考题目，AI 会据此出题：可直接引用原题或参考出题范式',
    questionBankPlaceholder: '粘贴参考题目...',
    questionBankClear: '清除题库',
    questionBankUpload: '导入文件',
    questionBankActive: '已加载题库',
    ttsTitle: '语音合成',
...
export const commonEnUS = {
  ...
  toolbar: {
    ...
    questionBankActive: 'Bank loaded',
