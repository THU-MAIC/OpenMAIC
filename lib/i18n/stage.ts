...
export const stageRuRU = {
  stage: {
    ...
    confirmSwitchMessage:
      'Сейчас идёт активная тема. Переключение сцены завершит текущую тему. Продолжить?',
    generatingNextPage: 'Сцена ещё генерируется, подожди немного...',
  },
  whiteboard: {
    ...
    clearError: 'Не удалось очистить доску: ',
    resetView: 'Сбросить вид',
    zoomHint: 'Колесо для зума, перетаскивание для панорамы',
    restoreError: 'Не удалось восстановить доску: ',
    history: 'История',
    restore: 'Восстановить',
    beforeClear: 'До очистки',
    beforeAIClear: 'До очистки AI',
  ...
  quiz: {
    title: 'Квиз',
    subtitle: 'Проверь, что ты усвоил',
    questionsCount: 'вопросов',
    totalPrefix: '',
    pointsSuffix: 'баллов',
    startQuiz: 'Начать квиз',
    multipleChoiceHint: '(Несколько вариантов, выбери все правильные ответы)',
    inputPlaceholder: 'Введите ответ...',
    charCount: 'симв.',
    yourAnswer: 'Твой ответ:',
    notAnswered: 'Без ответа',
    aiComment: 'Комментарий AI',
    ...
    aiGradingWait: 'Подожди, AI анализирует твои ответы',
    quizReport: 'Отчёт по квизу',
    retry: 'Пройти снова',
  },
  roundtable: {
    ...
    qaEnded: 'Q&A завершён',
    thinking: 'Думаю',
    yourTurn: 'Твой ход',
    stopDiscussion: 'Остановить обсуждение',
    autoPlay: 'Автовоспроизведение',
    autoPlayOff: 'Выключить автовоспроизведение',
    speed: 'Скорость',
  },
  pbl: {
    legacyFormat: 'Эта PBL-сцена использует старый формат. Пересоздай курс.',
    emptyProject: 'PBL-проект ещё не сгенерирован. Сначала создай его через генерацию курса.',
    roleSelection: {
      title: 'Выбери роль',
      description: 'Выбери роль, чтобы начать совместную работу над проектом',
    },
    workspace: {
    ...
    chat: {
      ...
      mentionHint: 'Используй @question для вопросов и @judge для отправки на проверку',
      placeholder: 'Введите сообщение...',
      send: 'Отправить',
      welcomeMessage:
        'Привет! Я агент вопросов по задаче: «{title}»\n\nЧтобы тебе было проще начать, я подготовил несколько направляющих вопросов:\n\n{questions}\n\nЕсли нужна помощь или уточнение, просто тегни меня через @question!',
      issueCompleteMessage: 'Задача «{completed}» завершена. Переходим к следующей: «{next}»',
      allCompleteMessage: '🎉 Все задачи завершены. Отличная работа над проектом!',
    },
    guide: {
      ...
      title: 'Помощь',
      step1: {
        title: 'Шаг 1: Выбери роль',
        desc: 'Когда проект сгенерируется, выбери роль из списка, кроме системных, они отмечены 🟢',
      },
      step2: {
        title: 'Шаг 2: Выполняй задачи',
        desc: 'Каждая задача это отдельная учебная цель:',
        s1: {
          title: 'Открой текущую задачу',
          desc: 'Посмотри название, описание и назначенного исполнителя',
        },
        s2: {
          title: 'Получи подсказку',
          example: '@question С чего лучше начать?\n@question Как реализовать эту фичу?',
          desc: 'Агент вопросов подсказывает направление и даёт наводки, но не выдаёт готовый ответ',
        },
        s3: {
          title: 'Отправь результат',
          example: '@judge Я закончил, проверь мои заметки',
          desc: 'Агент-судья оценит твою работу и даст фидбек:',
          complete: 'Автоматически переведёт к следующей задаче',
          revision: 'Попросит доработать по замечаниям',
        },
      },
      step3: {
        title: 'Шаг 3: Заверши проект',
        desc: 'Когда все задачи будут выполнены, система покажет «🎉 Проект завершён!»',
      },
    },
  },
  share: {
    notReady: 'Станет доступно после завершения генерации',
  },
} as const;
