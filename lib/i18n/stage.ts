...
export const stageEsMX = {
  stage: {
    ...
    confirmSwitchMessage:
      'Hay un tema en curso. Cambiar de escena finalizará el tema actual. ¿Estás seguro?',
    generatingNextPage: 'La escena se está generando, por favor espera...',
  ...
  whiteboard: {
    ...
    clearSuccess: 'Pizarra limpiada exitosamente',
    clearError: 'Error al limpiar la pizarra: ',
    resetView: 'Restablecer Vista',
    restoreError: 'Error al restaurar la pizarra: ',
    history: 'Historial',
    restore: 'Restaurar',
    noHistory: 'Sin historial aún',
    restored: 'Pizarra restaurada',
  ...
  quiz: {
    ...
    multipleChoiceHint: '(Opción múltiple — selecciona todas las respuestas correctas)',
    inputPlaceholder: 'Escribe tu respuesta aquí...',
    charCount: 'caracteres',
    yourAnswer: 'Tu respuesta:',
    notAnswered: 'Sin responder',
    aiComment: 'Retroalimentación IA',
  ...
  roundtable: {
    ...
    discussionEnded: 'Discusión finalizada',
    qaEnded: 'Preguntas finalizadas',
    thinking: 'Pensando',
    yourTurn: 'Tu turno',
    stopDiscussion: 'Detener Discusión',
    autoPlay: 'Reproducción automática',
    autoPlayOff: 'Detener reproducción automática',
    speed: 'Velocidad',
    voiceInput: 'Entrada de voz',
    voiceInputDisabled: 'Entrada de voz deshabilitada',
    textInput: 'Entrada de texto',
    stopRecording: 'Detener grabación',
    startRecording: 'Iniciar grabación',
  },
  pbl: {
    legacyFormat: 'Esta escena PBL usa un formato anterior. Por favor regenera el curso.',
    emptyProject:
      'El proyecto PBL aún no se ha generado. Por favor créalo mediante la generación de curso.',
    roleSelection: {
      title: 'Elige Tu Rol',
      description: 'Selecciona un rol para comenzar a colaborar en el proyecto',
    },
    workspace: {
      restart: 'Reiniciar',
      confirmRestart: '¿Reiniciar todo el progreso?',
      confirm: 'Confirmar',
      cancel: 'Cancelar',
    },
    issueboard: {
      title: 'Tablero de Tareas',
      noIssues: 'Sin tareas aún',
    ...
    chat: {
      ...
      mentionHint: 'Usa @question para preguntar, @judge para enviar a revisión',
      placeholder: 'Escribe un mensaje...',
      send: 'Enviar',
      welcomeMessage:
        '¡Hola! Soy tu Agente de Preguntas para esta tarea: "{title}"\n\nPara guiar tu trabajo, he preparado algunas preguntas:\n\n{questions}\n\n¡No dudes en usar @question si necesitas ayuda o aclaraciones!',
      issueCompleteMessage:
        '¡Tarea "{completed}" completada! Pasando a la siguiente tarea: "{next}"',
      allCompleteMessage: '🎉 ¡Todas las tareas completadas! ¡Excelente trabajo en el proyecto!',
    },
    guide: {
      ...
      step2: {
        title: 'Paso 2: Completa las Tareas',
        desc: 'Cada tarea representa un objetivo de aprendizaje:',
        s1: {
          title: 'Ver tarea actual',
          desc: 'Revisa el título, descripción y responsable de la tarea',
        },
        s2: {
          title: 'Obtener orientación',
          example:
            '@question ¿Por dónde debo empezar?\n@question ¿Cómo implemento esta función?',
          desc: 'El Agente de Preguntas proporciona preguntas guía y pistas (sin respuestas directas)',
        },
        s3: {
          title: 'Enviar tu trabajo',
          example: '@judge Ya terminé, por favor revisa mis Notas',
          desc: 'El Agente Evaluador evalúa tu trabajo y da retroalimentación:',
          complete: 'Avanza automáticamente a la siguiente tarea',
          revision: 'Mejora según la retroalimentación',
        },
      },
      step3: {
        title: 'Paso 3: Completa el Proyecto',
        desc: 'Cuando todas las tareas estén listas, el sistema muestra "🎉 ¡Proyecto Completado!"',
      },
    },
  },
  share: {
    notReady: 'Disponible después de completar la generación',
  },
} as const;
