...
export const settingsEsMX = {
  settings: {
    ...
    apiBaseUrlDesc: 'Configura la URL de tu endpoint API',
    ...
    testConnectionDesc: 'Probar que la configuración API actual esté disponible',
    testing: 'Probando...',
    agentSettings: 'Configuración de Agentes',
    agentSettingsDesc:
      'Selecciona los agentes que participarán en la conversación. Selecciona 1 para modo de agente único, selecciona varios para modo colaborativo multi-agente.',
    agentMode: 'Modo de Agente',
    agentModePreset: 'Preestablecido',
    agentModeAuto: 'Auto-generar',
    agentModeAutoDesc: 'La IA generará automáticamente roles apropiados',
    autoAgentCount: 'Cantidad de Agentes',
    autoAgentCountDesc: 'Número de agentes a auto-generar (incluyendo profesor)',
    ...
    maxTurnsDesc:
      'El número máximo de turnos de discusión entre agentes (cada agente completa acciones y responde cuenta como un turno)',
    priority: 'Prioridad',
    actions: 'Acciones',
    ...
    agentDescriptions: {
      'default-1': 'Profesor principal con explicaciones claras y estructuradas',
      'default-2': 'Apoya el aprendizaje y ayuda a aclarar puntos clave',
      'default-3': 'Aporta humor y energía al aula',
      'default-4': 'Siempre curioso, le encanta preguntar por qué y cómo',
    ...
    addProviderDialog: 'Agregar Proveedor de Modelos',
    providerName: 'Nombre',
    ...
    deleteProviderConfirm: '¿Estás seguro de que deseas eliminar este proveedor?',
    cannotDeleteBuiltIn: 'No se puede eliminar un proveedor integrado',
    resetToDefault: 'Restablecer a Predeterminado',
    resetToDefaultDescription:
      'Restaurar la lista de modelos a la configuración predeterminada (se conservarán la clave API y URL Base)',
    resetConfirmDescription:
      'Esto eliminará todos los modelos personalizados y restaurará la lista de modelos integrados. La clave API y URL Base se conservarán.',
    confirmReset: 'Confirmar Restablecimiento',
    resetSuccess: 'Restablecido exitosamente a la configuración predeterminada',
    saveSuccess: 'Ajustes guardados',
    saveFailed: 'Error al guardar ajustes, intenta de nuevo',
    cannotDeleteBuiltInModel: 'No se puede eliminar un modelo integrado',
    cannotEditBuiltInModel: 'No se puede editar un modelo integrado',
    ...
    editModelDescription: 'Editar configuración y capacidades del modelo',
    addNewModel: 'Nuevo Modelo',
    addNewModelDescription: 'Agregar una nueva configuración de modelo',
    ...
    saveModel: 'Guardar',
    modelsManagementDescription:
      'Administra los modelos de este proveedor. Para seleccionar el modelo activo, ve a "General".',
    // General settings
    howToUse: 'Cómo Usar',
    step1ConfigureProvider:
      'Ve a "Proveedores de Modelos", selecciona o agrega un proveedor y configura los ajustes de conexión (clave API, URL Base, etc.)',
    ...
    activeModelDescription: 'Selecciona el modelo para conversaciones de IA y generación de contenido',
    selectModel: 'Seleccionar Modelo',
    searchModels: 'Buscar modelos',
    noModelsFound: 'No se encontraron modelos coincidentes',
    noConfiguredProviders: 'Sin proveedores configurados',
    configureProvidersFirst:
      'Por favor configura los ajustes de conexión del proveedor en "Proveedores de Modelos" a la izquierda',
    ...
    ttsEnabledDescription: 'Cuando está habilitado, se generará audio de voz durante la creación del curso',
    ttsVoiceConfigHint:
      'La voz de cada agente se puede configurar en "Configuración de Roles del Aula" en la página principal',
    enableASR: 'Habilitar Reconocimiento de Voz',
    asrEnabledDescription: 'Cuando está habilitado, los estudiantes pueden usar el micrófono para entrada de voz',
    ...
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'TTS nativo del navegador no requiere configuración y es completamente gratuito, usa las voces integradas del sistema',
    testTTS: 'Probar TTS',
    testASR: 'Probar ASR',
    ...
    microphoneAccessFailed: 'Error al acceder al micrófono',
    ...
    fetchVoicesFailed: 'Error al obtener voces',
    voiceApiKeyRequired: 'Se requiere Clave API',
    voiceBaseUrlRequired: 'Se requiere URL Base',
    ttsTestTextPlaceholder: 'Ingresa texto para convertir',
    ttsTestTextDefault: 'Hola, esta es una prueba de voz.',
    ...
    voiceAlloy: 'Neutral, Equilibrado',
    ...
    // TTS Voice descriptions (Qwen)
    qwenVoiceCherry: 'Soleada, cálida y natural',
    qwenVoiceSerena: 'Suave y delicada',
    qwenVoiceEthan: 'Enérgico y vibrante',
    qwenVoiceChelsie: 'Novia virtual anime',
    qwenVoiceMomo: 'Juguetona y alegre',
    qwenVoiceVivian: 'Linda y atrevida',
    qwenVoiceMoon: 'Cool y apuesto',
    qwenVoiceMaia: 'Intelectual y gentil',
    qwenVoiceKai: 'Un SPA para tus oídos',
    qwenVoiceNofish: 'Diseñador con acento peculiar',
    qwenVoiceBella: 'Pequeña loli que no se emborracha',
    qwenVoiceJennifer: 'Voz femenina americana de nivel cinematográfico',
    qwenVoiceRyan: 'Ritmo rápido, actuación dramática',
    qwenVoiceKaterina: 'Dama madura con ritmo memorable',
    qwenVoiceAiden: 'Chico americano que domina la cocina',
    qwenVoiceEldricSage: 'Anciano estable y sabio',
    qwenVoiceMia: 'Gentil como agua de manantial',
    qwenVoiceMochi: 'Pequeño adulto inteligente con inocencia infantil',
    qwenVoiceBellona: 'Voz fuerte, pronunciación clara, personajes vívidos',
    qwenVoiceVincent: 'Voz ronca única narrando historias de guerra y honor',
    qwenVoiceBunny: 'Súper linda loli',
    qwenVoiceNeil: 'Presentador de noticias profesional',
    qwenVoiceElias: 'Instructor profesional',
    qwenVoiceArthur: 'Voz simple curtida por los años',
    qwenVoiceNini: 'Voz suave y pegajosa como pastel de arroz',
    qwenVoiceEbona: 'Su susurro es como una llave oxidada',
    qwenVoiceSeren: 'Voz gentil y relajante para ayudarte a dormir',
    qwenVoicePip: 'Travieso pero lleno de inocencia infantil',
    qwenVoiceStella: 'Voz de chica dulce y confundida que se vuelve justa al gritar',
    qwenVoiceBodega: 'Tío español entusiasta',
    qwenVoiceSonrisa: 'Señora latinoamericana entusiasta',
    qwenVoiceAlek: 'Frío de nación guerrera, cálido bajo el abrigo de lana',
    qwenVoiceDolce: 'Tío italiano relajado',
    qwenVoiceSohee: 'Unnie coreana gentil y alegre',
    ...
    qwenVoiceJada: 'Señora de Shanghai vivaz',
    qwenVoiceDylan: 'Chico de Beijing',
    qwenVoiceLi: 'Profesora de yoga paciente',
    qwenVoiceMarcus: 'Cara ancha, pocas palabras, corazón firme - sabor del viejo Shaanxi',
    qwenVoiceRoy: 'Chico taiwanés humorístico y directo',
    qwenVoicePeter: 'Profesional del stand-up de Tianjin',
    qwenVoiceSunny: 'Chica dulce de Sichuan',
    qwenVoiceEric: 'Caballero de Chengdu',
    qwenVoiceRocky: 'Chico de Hong Kong humorístico',
    qwenVoiceKiki: 'Chica dulce de Hong Kong',
    // ASR Language names (native forms - autoglossonyms)
    ...
    pdfDescription:
      'Elige el motor de análisis de PDF con soporte para extracción de texto, procesamiento de imágenes y reconocimiento de tablas',
    pdfProvider: 'Analizador de PDF',
    pdfFeatures: 'Funciones Soportadas',
    pdfApiKey: 'Clave API',
    pdfBaseUrl: 'URL Base',
    mineruDescription:
      'MinerU es un servicio comercial de análisis de PDF que soporta funciones avanzadas como extracción de tablas, reconocimiento de fórmulas y análisis de diseño.',
    mineruApiKeyRequired: 'Necesitas solicitar una Clave API en el sitio web de MinerU antes de usar.',
    mineruWarning: 'Advertencia',
    mineruCostWarning:
      'MinerU es un servicio comercial y puede generar cargos. Consulta el sitio web de MinerU para detalles de precios.',
    enterMinerUApiKey: 'Ingresa la Clave API de MinerU',
    mineruLocalDescription:
      'MinerU soporta despliegue local con análisis avanzado de PDF (tablas, fórmulas, análisis de diseño). Requiere desplegar el servicio MinerU primero.',
    mineruServerAddress: 'Dirección del servidor local MinerU (ej., http://localhost:8080)',
    mineruApiKeyOptional: 'Solo requerido si el servidor tiene autenticación habilitada',
    ...
    featureLayoutAnalysis: 'Análisis de Diseño',
    featureMetadata: 'Metadatos',
    // Image Generation settings
    enableImageGeneration: 'Habilitar Gen. Imágenes IA',
    imageGenerationDisabledHint:
      'Cuando está habilitado, las imágenes se generarán automáticamente durante la creación del curso',
    imageSettings: 'Gen. Imágenes',
    ...
    providerNanoBanana: 'Nano Banana (Gemini)',
    providerGrokImage: 'Grok Image (xAI)',
    testImageGeneration: 'Probar Gen. Imágenes',
    testImageConnectivity: 'Probar Conexión',
    imageConnectivitySuccess: 'Servicio de imágenes conectado exitosamente',
    imageConnectivityFailed: 'Error de conexión del servicio de imágenes',
    imageTestSuccess: 'Prueba de gen. imágenes exitosa',
    imageTestFailed: 'Prueba de gen. imágenes fallida',
    imageTestPromptPlaceholder: 'Ingresa descripción de imagen para probar',
    imageTestPromptDefault: 'Un lindo gato sentado en un escritorio',
    imageGenerating: 'Generando imagen...',
    imageGenerationFailed: 'Error en la generación de imagen',
    // Video Generation settings
    enableVideoGeneration: 'Habilitar Gen. Video IA',
    videoGenerationDisabledHint:
      'Cuando está habilitado, los videos se generarán automáticamente durante la creación del curso',
    videoSettings: 'Gen. Video',
    ...
    providerSora: 'Sora (OpenAI)',
    providerGrokVideo: 'Grok Video (xAI)',
    testVideoGeneration: 'Probar Gen. Video',
    testVideoConnectivity: 'Probar Conexión',
    videoConnectivitySuccess: 'Servicio de video conectado exitosamente',
    videoConnectivityFailed: 'Error de conexión del servicio de video',
    testingConnection: 'Probando...',
    videoTestSuccess: 'Prueba de gen. video exitosa',
    videoTestFailed: 'Prueba de gen. video fallida',
    videoTestPromptDefault: 'Un lindo gato caminando sobre un escritorio',
    videoGenerating: 'Generando video (est. 1-2 min)...',
    videoGenerationWarning: 'La generación de video generalmente toma 1-2 minutos, por favor sé paciente',
    mediaRetry: 'Reintentar',
    mediaContentSensitive: 'Lo sentimos, este contenido activó una verificación de seguridad.',
    mediaGenerationDisabled: 'Generación deshabilitada en ajustes',
    // Agent settings (kept with main settings block above)
    singleAgent: 'Agente Único',
    multiAgent: 'Multi-Agente',
    selectAgents: 'Seleccionar Agentes',
    noVisionWarning:
      'El modelo actual no soporta visión. Las imágenes aún se pueden colocar en diapositivas, pero el modelo no puede entender el contenido de las imágenes para optimizar la selección y el diseño',
    // Server provider configuration
    serverConfigured: 'Servidor',
    serverConfiguredNotice:
      'El administrador ha configurado una clave API para este proveedor en el servidor. Puedes usarla directamente o ingresar tu propia clave para sobrescribir.',
    optionalOverride: 'Opcional — dejar vacío para usar la configuración del servidor',
    // Access code
    setupNeeded: 'Configuración requerida',
    modelNotConfigured: 'Por favor selecciona un modelo para comenzar',
    // Clear cache
    dangerZone: 'Zona de Peligro',
    clearCache: 'Limpiar Caché Local',
    clearCacheDescription:
      'Eliminar todos los datos almacenados localmente, incluyendo registros de aulas, historial de chat, caché de audio y ajustes de la aplicación. Esta acción no se puede deshacer.',
    clearCacheConfirmTitle: '¿Estás seguro de que deseas limpiar todo el caché?',
    clearCacheConfirmDescription:
      'Esto eliminará permanentemente todos los siguientes datos y no se pueden recuperar:',
    clearCacheConfirmItems:
    ...
    clearCacheConfirmPhrase: 'ELIMINAR',
    clearCacheButton: 'Eliminar Permanentemente Todos los Datos',
    clearCacheSuccess: 'Caché limpiado, la página se actualizará en breve',
    clearCacheFailed: 'Error al limpiar el caché, intenta de nuevo',
    // Web Search settings
    ...
    webSearchApiKeyPlaceholderServer: 'Clave del servidor configurada, opcionalmente sobrescribir',
    webSearchApiKeyHint: 'Obtén una clave API de tavily.com para búsqueda web',
    webSearchBaseUrl: 'URL Base',
    webSearchServerConfigured: 'Clave API de Tavily del lado del servidor configurada',
    optional: 'Opcional',
  },
  profile: {
    title: 'Perfil',
    ...
    uploadAvatar: 'Subir',
    bioPlaceholder: 'Cuéntanos sobre ti — el profesor IA personalizará las clases para ti...',
    avatarHint: 'Tu avatar aparecerá en las discusiones y chats del aula',
    fileTooLarge: 'Imagen demasiado grande — por favor elige una menor a 5 MB',
    invalidFileType: 'Por favor selecciona un archivo de imagen',
    editTooltip: 'Clic para editar perfil',
  },
  media: {
    imageCapability: 'Gen. Imágenes',
    imageHint: 'Generar imágenes en diapositivas',
    videoCapability: 'Gen. Video',
    ...
    asrHint: 'Entrada de voz para discusión',
    provider: 'Proveedor',
    model: 'Modelo',
    voice: 'Voz',
    speed: 'Velocidad',
