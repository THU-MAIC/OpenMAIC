...
export const settingsRuRU = {
  settings: {
    ...
    confirmChangeProvider: 'Сменить провайдера?',
    confirmChangeProviderText: 'Текущие настройки будут сброшены. Продолжить?',
    save: 'Сохранить',
    cancel: 'Отмена',
    // Sections
    ...
    audioDescription: 'Настройка синтеза и распознавания речи',
    advanced: 'Дополнительно',
    // AI Provider settings
    defaultModelGroup: 'Основные модели',
    apiKeyPlaceholder: 'Введите API-ключ',
    apiKeyServerConfigured: 'Серверный ключ настроен, можно ввести свой',
    baseUrlPlaceholder: 'Введите Base URL',
    baseUrlOptional: 'Base URL (необязательно)',
    baseUrlDefault: 'По умолчанию',
    customModelPlaceholder: 'Или введите произвольный ID модели',
    addCustomModel: 'Добавить модель',
    addedCustomModel: 'Модель добавлена',
    removedCustomModel: 'Модель удалена',
    // Audio settings
    ...
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'Встроенный TTS браузера не требует настройки и полностью бесплатен, использует системные голоса',
    testTTS: 'Тест TTS',
    testASR: 'Тест ASR',
    ...
    // ASR Language names (native forms)
    ...
    pdfDescription:
      'Выберите движок для обработки PDF с поддержкой извлечения текста, изображений и таблиц',
    pdfProvider: 'PDF-парсер',
    pdfFeatures: 'Поддерживаемые функции',
    pdfApiKey: 'API-ключ',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU — коммерческий сервис обработки PDF с поддержкой извлечения таблиц, распознавания формул и анализа макета.',
    mineruApiKeyRequired: 'Перед использованием необходимо получить API-ключ на сайте MinerU.',
    mineruWarning: 'Внимание',
    mineruCostWarning:
      'MinerU — коммерческий сервис, использование может быть платным. Проверьте цены на сайте MinerU.',
    enterMinerUApiKey: 'Введите MinerU API-ключ',
    mineruLocalDescription:
      'MinerU поддерживает локальное развёртывание с расширенной обработкой PDF (таблицы, формулы, анализ макета). Требуется предварительное развёртывание сервиса MinerU.',
    ...
    imageGenerationDisabledHint:
      'При включении изображения будут автоматически генерироваться во время создания курса',
    ...
    videoGenerationDisabledHint:
      'При включении видео будут автоматически генерироваться во время создания курса',
    ...
    noVisionWarning:
      'Текущая модель не поддерживает зрение. Изображения по-прежнему можно размещать на слайдах, но модель не сможет понимать содержимое изображений для оптимизации',
    // Server provider configuration
    serverConfigured: 'Сервер',
    serverConfiguredNotice:
      'Администратор настроил API-ключ для этого провайдера на сервере. Можете использовать его напрямую или ввести свой ключ.',
    ...
    clearCacheDescription:
      'Удалить все локально сохранённые данные, включая записи классов, историю чатов, аудиокэш и настройки приложения. Это действие нельзя отменить.',
    clearCacheConfirmTitle: 'Вы уверены, что хотите очистить весь кэш?',
    clearCacheConfirmDescription:
      'Это навсегда удалит все следующие данные без возможности восстановления:',
    clearCacheConfirmItems:
      'Классы и сцены, История чатов, Аудио- и графический кэш, Настройки и предпочтения',
