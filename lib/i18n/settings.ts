export const settingsZhCN = {
  settings: {
    ...
    allLanguages: '全部语言',
    ttsVoice: '音色',
    ttsTeacherVoice: '教师音色',
    ttsStudentVoice: '学生音色',
    ttsSpeed: '语速',
    ttsBaseUrl: 'Base URL',
    ttsApiKey: 'API 密钥',
    doubaoAppId: 'App ID',
    ...
    providerOpenAITTS: 'OpenAI TTS (Standard)',
    ...
    providerOpenAIWhisper: 'OpenAI ASR (Standard)',
    ...
    providerLocalImage: 'Local Image（本地）',
...
export const settingsEnUS = {
  settings: {
    ...
    ttsVoice: 'Voice',
    ttsTeacherVoice: 'Teacher voice',
    ttsStudentVoice: 'Student voice',
    ttsSpeed: 'Speed',
    ttsBaseUrl: 'Base URL',
    ttsApiKey: 'API Key',
    doubaoAppId: 'App ID',
    ...
    providerGrokImage: 'Grok Image (xAI)',
    providerLocalImage: 'Local Image (SDXL-Turbo)',
  ...
  auth: {
    ...
    loginDesc: 'Sign in to access your classrooms',
    email: 'Email',
    password: 'Password',
    signIn: 'Sign in',
    signOut: 'Sign out',
    ...
    registerDesc: 'Register a new account',
    name: 'Name',
...
export const settingsUz = {
  settings: {
    title: 'Sozlamalar',
    description: 'Ilova sozlamalarini tahrirlash',
    language: 'Til',
    languageDesc: 'Interfeys tilini tanlash',
    theme: 'Mavzu',
    themeDesc: 'Mavzuni tanlash (Yorqin/Qorongʻi/Tizim)',
    themeOptions: {
      light: 'Yorqin',
      dark: 'Qorongʻi',
      system: 'Tizim',
    ...
    apiKey: 'API kalit',
    apiKeyDesc: 'API kalitingizni sozlash',
    apiBaseUrl: 'API URL manzili',
    apiBaseUrlDesc: 'API manzilini sozlash (End point)',
    apiKeyRequired: 'API kalit boʻsh boʻlishi mumkin emas',
    model: 'Modelni sozlash',
    modelDesc: 'AI modellarini sozlash',
    modelPlaceholder: 'Model nomini kiriting yoki tanlang',
    ttsModel: 'TTS modeli',
    ttsModelDesc: 'TTS modellarini sozlash',
    ttsModelPlaceholder: 'TTS modeli nomini kiriting yoki tanlang',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    testConnection: 'Ulanishni tekshirish',
    testConnectionDesc: 'Joriy API sozlamalari ishlashini tekshirish',
    testing: 'Tekshirilmoqda...',
    agentSettings: 'Agent sozlamalari',
    agentSettingsDesc:
      'Suhbatda qatnashuvchi agentlarni tanlang. Bitta boʻlsa Yagona agent, koʻp boʻlsa Koʻp agentli hamkorlik rejimi.',
    agentMode: 'Agent rejimi',
    agentModePreset: 'Oldindan tayyor',
    agentModeAuto: 'Avtomatik yaratish',
    agentModeAutoDesc: 'AI avtomatik ravishda mos rollarni yaratadi',
    autoAgentCount: 'Agentlar soni',
    autoAgentCountDesc: 'Avto-yaratiladigan agentlar soni (oʻqituvchi bilan birga)',
    atLeastOneAgent: 'Iltimos, kamida 1 ta agent tanlang',
    singleAgentMode: 'Yagona agent rejimi',
    directAnswer: 'Toʻgʻridan-toʻgʻri javob',
    multiAgentMode: 'Koʻp agentli rejim',
    agentsCollaborating: 'Hamkorlikdagi muhokama',
    agentsCollaboratingCount: 'Hamkorlik uchun {count} ta agent tanlandi',
    maxTurns: 'Maks. muhokama davri',
    maxTurnsDesc:
      'Agentlar orasidagi maksimal muhokama davri (har bir agent navbati bir davr hisoblanadi)',
    priority: 'Ustuvorlik',
    actions: 'Amallar',
    actionCount: '{count} ta amal',
    selectedAgent: 'Tanlangan agent',
    selectedAgents: 'Tanlangan agentlar',
    required: 'Majburiy',
    agentNames: {
      'default-1': 'AI Oʻqituvchi',
      'default-2': 'AI Yordamchi',
      'default-3': 'Sinf qiziqchisi',
      'default-4': 'Qiziquvchan kishi',
      'default-5': 'Qayd etuvchi',
      'default-6': 'Chuqur oʻylovchi',
    },
    agentRoles: {
      teacher: 'Oʻqituvchi',
      assistant: 'Yordamchi',
    ...
    agentDescriptions: {
      'default-1': 'Bosh oʻqituvchi, aniq va tizimli tushuntiradi',
      'default-2': 'Oʻrganishni qoʻllab-quvvatlaydi, muhim joylarni tushuntiradi',
      'default-3': 'Sinfga hazil va energiya olib kiradi',
      'default-4': 'Doim qiziquvchan, qanday va nima uchun soʻrashni yaxshi koʻradi',
      'default-5': 'Qaydlar qiladi va dars maʼlumotlarini yigʻadi',
      'default-6': 'Chuqur oʻylaydi va mavzu mohiyatini yoritadi',
    },
    close: 'Yopish',
    save: 'Saqlash',
    providers: 'LLM',
    addProviderDescription: 'Qoʻshimcha AI modellar uchun moslashtirilgan provayderlarni qoʻshish',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    providerTypes: {
      openai: 'OpenAI bayonnomasi',
      anthropic: 'Claude bayonnomasi',
      google: 'Gemini bayonnomasi',
    },
    modelCount: 'modellar',
    modelSingular: 'model',
    ...
    documentParser: 'Hujjat tahlilchisi',
    conversationSettings: 'Suhbat',
    keyboardShortcuts: 'Klaviatura',
    generalSettings: 'Asosiy',
    systemSettings: 'Tizim',
    addProvider: 'Qoʻshish',
    importFromClipboard: 'Nusxa oynasidan import',
    apiSecret: 'API kalit',
    apiHost: 'Base URL',
    requestUrl: 'Soʻrov URL si',
    models: 'Modellar',
    addModel: 'Yangi',
    reset: 'Tiklash',
    fetch: 'Olish',
    connectionSuccess: 'Muvaffaqiyatli ulandi',
    connectionFailed: 'Ulanib boʻlmadi',
    capabilities: {
      vision: 'Koʻrish',
      tools: 'Asboblar',
      streaming: 'Oqim(Streaming)',
    },
    contextWindow: 'Kontekst',
    contextShort: 'kon',
    outputWindow: 'Natija',
    addProviderButton: 'Qoʻshish',
    addProviderDialog: 'Model provayderi qoʻshish',
    providerName: 'Nom',
    providerNamePlaceholder: 'masalan, Mening OpenAI proksim',
    providerNameRequired: 'Provayder nomini kiriting',
    providerApiMode: 'API rejimi',
    apiModeOpenAI: 'OpenAI bayonnomasi',
    apiModeAnthropic: 'Claude bayonnomasi',
    apiModeGoogle: 'Gemini bayonnomasi',
    defaultBaseUrl: 'Odatiy Base URL',
    providerIcon: 'Provayder icon URL si',
    requiresApiKey: 'API kalit talab qilinadi',
    deleteProvider: 'Provayderni oʻchirish',
    deleteProviderConfirm: 'Rostdan ham bu provayderni oʻchirasizmi?',
    cannotDeleteBuiltIn: 'Ichki provayderni oʻchirib boʻlmaydi',
    resetToDefault: 'Odatiy holatga qaytarish',
    resetToDefaultDescription:
      'Modellar roʻyxatini odatiy holatga qaytarish (API kalit va Base URL saqlanadi)',
    resetConfirmDescription:
      'Bu barcha maxsus modellarni oʻchirib, ichki odatiy modellarni tiklaydi. API kalit va Base URL saqlanadi.',
    confirmReset: 'Qaytarishni tasdiqlash',
    resetSuccess: 'Odatiy xolat muvaffaqiyatli tiklandi',
    saveSuccess: 'Sozlamalar saqlandi',
    saveFailed: 'Sozlamalarni saqlab boʻlmadi, qayta urinib koʻring',
    cannotDeleteBuiltInModel: 'Ichki modelni oʻchirib boʻlmaydi',
    cannotEditBuiltInModel: 'Ichki modelni tahrirlab boʻlmaydi',
    modelIdRequired: 'Model ID sini kiriting',
    noModelsAvailable: 'Tekshirish uchun modellar mavjud emas',
    providerMetadata: 'Provayder meta-maʼlumoti',
    editModel: 'Modelni tahrirlash',
    editModelDescription: 'Model sozlamalari va imkoniyatlari',
    addNewModel: 'Yangi model',
    addNewModelDescription: 'Yangi model sozlamasi',
    modelId: 'Model ID',
    modelIdPlaceholder: 'masalan, gpt-4o',
    modelName: 'Display nomi',
    modelNamePlaceholder: 'Ixtiyoriy',
    modelCapabilities: 'Imkoniyatlar',
    advancedSettings: 'Qoʻshimcha sozlamalar',
    contextWindowLabel: 'Kontekst oynasi',
    contextWindowPlaceholder: 'masalan, 128000',
    outputWindowLabel: 'Maks. javob tokeni',
    outputWindowPlaceholder: 'masalan, 4096',
    testModel: 'Modelni tekshirish',
    deleteModel: 'Oʻchirish',
    cancelEdit: 'Bekor qilish',
    saveModel: 'Saqlash',
    modelsManagementDescription:
      'Ushbu provayder uchun modellarni boshqarish. Faol model tanlash uchun "Asosiy"ga oʻting.',
    howToUse: 'Qanday ishlatish',
    step1ConfigureProvider:
      '"Model Provayderlari"ga oʻting, provayder qoʻshing, va ulanishni sozlang (API kalit, Base URL, va boshq.)',
    step2SelectModel: 'Quyida "Faol Model" qismida foydalaniladigan modelni tanlang',
    step3StartUsing: 'Saqlangandan soʻng asosiysiz tanlagan modeldan foydalanamiz',
    activeModel: 'Faol model',
    activeModelDescription: 'Suhbat va yaratish uchun asosiysi modelni tanlang',
    selectModel: 'Model tanlash',
    searchModels: 'Modellarni qidirish',
    noModelsFound: 'Mos model topilmadi',
    noConfiguredProviders: 'Sozlangan provayderlar yoʻq',
    configureProvidersFirst:
      'Iltimos, chapdagi "Model Provayderlari"da avval ulanishni sozlang',
    currentlyUsing: 'Hozirda foydalanilmoqda',
    ttsSettings: 'Matndan nutqqa',
    asrSettings: 'Nutqni aniqlash',
    audioSettings: 'Ovoz sozlamalari',
    ttsSection: 'Matndan nutqqa (TTS)',
    asrSection: 'Nutqni aniqlash (ASR)',
    ttsDescription: 'TTS (Text-to-Speech) - Matnni nutqqa aylantirish',
    asrDescription: 'ASR (Automatic Speech Recognition) - Nutqni matnga aylantirish',
    enableTTS: 'Matndan nutqni yoqish (TTS)',
    ttsEnabledDescription: 'Yoqilganda, kurs davomida ovoz avto-yaratiladi',
    ttsVoiceConfigHint:
      'Agentlar ovozi bosh sahifada "Sinfxona rollarini sozlash" da koʻrsatilishi mumkin',
    enableASR: 'Nutqni aniqlashni yoqish (ASR)',
    asrEnabledDescription: 'Yoqilganda, talabalar ovozli mikrofon ishlatib kirishlari mumkin',
    ttsProvider: 'TTS Provayderi',
    ttsLanguageFilter: 'Til filtri',
    allLanguages: 'Barcha tillar',
    ttsVoice: 'Ovoz',
    ttsTeacherVoice: "O'qituvchi ovozi",
    ttsStudentVoice: "Talaba ovozi",
    ttsSpeed: 'Tezlik',
    ttsBaseUrl: 'Base URL',
    ttsApiKey: 'API Kalit',
    doubaoAppId: 'Ilova ID',
    doubaoAccessKey: 'Kirish Kaliti',
    asrProvider: 'ASR Provayderi',
    asrLanguage: 'Aniqlash tili',
    asrBaseUrl: 'Base URL',
    asrApiKey: 'API kalit',
    enterApiKey: 'API kalitni kiriting',
    enterCustomBaseUrl: 'Maxsus Base URL kiriting',
    browserNativeNote: 'Brauzer native ASR hech qanday sozlama talab qilmaydi va bepul',
    ...
    providerDoubaoTTS: 'Doubao TTS 2.0 (Volcengine)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerBrowserNativeTTS: 'Brauzer Native TTS',
    providerOpenAIWhisper: 'OpenAI ASR (gpt-4o-mini-transcribe)',
    providerBrowserNative: 'Brauzer Native ASR',
    providerQwenASR: 'Qwen ASR (Alibaba Cloud Bailian)',
    providerUnpdf: 'unpdf (Ichki)',
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'Brauzer Native TTS sozlama talab qilmaydi va tizim ovozidan foydalanadi (bepul)',
    testTTS: 'TTS tekshir',
    testASR: 'ASR tekshir',
    testSuccess: 'Tekshirish Muvaffaqiyatli',
    testFailed: 'Tekshirish Amalga oshmadi',
    ttsTestText: 'TTS Tekshirish Matni',
    ttsTestSuccess: 'TTS Muvaffaqiyatli (audio ijro etildi)',
    ttsTestFailed: 'TTS tekshirish amalga oshmadi',
    asrTestSuccess: 'Nutqni farqlash ishladi!',
    asrTestFailed: 'Nutqni anglash ishlamadi',
    asrResult: 'Aniqlash Natijasi',
    asrNotSupported: 'Brauzer nutqni farqlash tizimini bilmaydi (API)',
    browserTTSNotSupported: 'Brauzer nutq sintez qilishni koʻtarmaydi',
    browserTTSNoVoices: 'Brauzerda tayyor ovozlar yuklanmagan',
    microphoneAccessDenied: 'Mikrofonga kirish cheklandi',
    microphoneAccessFailed: 'Mikrofonga ulanish muammosi',
    asrResultPlaceholder: 'Ovoz yozilgandan soʻng matn koʻrinadi',
    useThisProvider: 'Shu Provayderni ishlatish',
    fetchVoices: 'Ovozli Roʻyhatni yangilash',
    fetchingVoices: 'Olinmoqda...',
    voicesFetched: 'Ovozlar olingan',
    fetchVoicesFailed: 'Olish amalga oshmadi',
    voiceApiKeyRequired: 'API kalit majburiy',
    voiceBaseUrlRequired: 'Base URL majburiy',
    ttsTestTextPlaceholder: 'Konvertatsiya tekshiruvi uchun yozing',
    ttsTestTextDefault: 'Salom, bu test uchun.',
    startRecording: 'Yozishni boshlash',
    stopRecording: 'Yozishni toʻxtatish',
    recording: 'Yozilmoqda...',
    transcribing: 'Yechilmoqda (Transcribe)...',
    transcriptionResult: 'Natija (Transkripsa)',
    noTranscriptionResult: 'Natija chiqmadi',
    baseUrlOptional: 'Base URL (Ixtiyoriy)',
    defaultValue: 'Odatiy',
    voiceMarin: 'Tavsiya - Eng Sifatli',
    voiceCedar: 'Tavsiya - Eng Sifatli',
    voiceAlloy: 'Neytral, Balanslangan',
    voiceAsh: 'Professional, barqaror',
    voiceBallad: 'Nafis, Lirik',
    voiceCoral: 'Issiq, Doʻstona',
    voiceEcho: 'Erkak, Aniq',
    voiceFable: 'Hikoyali',
    voiceNova: 'Ayol, Yorqin',
    voiceOnyx: 'Erkak, Qalin',
    voiceSage: 'Donishmand, Sokin',
    voiceShimmer: 'Ayol, Yumshoq',
    voiceVerse: 'Tabiiy, Ravon',
    glmVoiceTongtong: 'Odatiy ovoz',
    glmVoiceChuichui: 'Chuichui ovozi',
    glmVoiceXiaochen: 'Xiaochen ovozi',
    glmVoiceJam: 'Jam ovozi',
    glmVoiceKazi: 'Kazi ovozi',
    glmVoiceDouji: 'Douji ovozi',
    glmVoiceLuodo: 'Luodo ovozi',
    qwenVoiceCherry: 'Yorqin, iliq va tabiiy',
    qwenVoiceSerena: 'Yumshoq',
    qwenVoiceEthan: 'Kuchli va gʻayratli',
    qwenVoiceChelsie: 'Anime dublyaji (qiz bola)',
    qwenVoiceMomo: 'Quvnoq va xushchaqchaq',
    qwenVoiceVivian: 'Yoqimli',
    qwenVoiceMoon: 'Salqin(Cool) va e`tiborli',
    qwenVoiceMaia: 'Ziyoli va muloyim',
    qwenVoiceKai: 'Quloq uchun taskin (SPA)',
    qwenVoiceNofish: "Dizayner",
    qwenVoiceBella: "Bolakay (loli)",
    qwenVoiceJennifer: 'Brendli, kino yulduzi ovozi',
    qwenVoiceRyan: 'Tez surʼatli, jozibali ijro',
    qwenVoiceKaterina: 'Katta ayol (ritmli)',
    qwenVoiceAiden: 'Pishirish ustasi',
    qwenVoiceEldricSage: 'Keksa va donishmand oqsoqol',
    qwenVoiceMia: 'Buvijondek yuvatuvchan',
    qwenVoiceMochi: 'Aqlli murgʻak bola',
    qwenVoiceBellona: 'Ovoz kuchli, jonli feʼl',
    qwenVoiceVincent: 'Qadimgi hikoyalardek jaranglovchi ovoz',
    qwenVoiceBunny: 'Juda shirin (loli)',
    qwenVoiceNeil: 'Professional qiroatchi/suhandon',
    qwenVoiceElias: 'Professional yoʻriqchi',
    qwenVoiceArthur: 'Oddiy mehnatkash obroʻyi',
    qwenVoiceNini: 'Yelimdek tortiluvchi xush ovoz',
    qwenVoiceEbona: 'Zanglagan kalitga oʻxshash shivir',
    qwenVoiceSeren: 'Uyqu tortuvchi osoyishta',
    qwenVoicePip: 'Shumtaka ammo sof',
    qwenVoiceStella: 'Shirin xudbin',
    qwenVoiceBodega: 'Kuyib yonuvchi Ispan yigiti',
    qwenVoiceSonrisa: 'Kuyib yonuvchi Latin ayoli',
    qwenVoiceAlek: 'Rus barqarorligi',
    qwenVoiceDolce: 'Dangasa italyan uslubi',
    qwenVoiceSohee: 'Yumshoq, kuluvchan koreys qiz',
    qwenVoiceOnoAnna: 'Bolalikdek shux-shodon doʻst',
    qwenVoiceLenn: 'Nemis post-pank kostyum yosh yigit',
    qwenVoiceEmilien: 'Romantik Fransuz uslubi',
    qwenVoiceAndre: 'Magnitli, tabiiy tinch erkak ovozi',
    qwenVoiceRadioGol: 'Futbol jarchisi (Radi GOL)',
    qwenVoiceJada: 'Jonli (Shanxay)',
    qwenVoiceDylan: 'Bolakay (Pekin)',
    qwenVoiceLi: 'Sabrli Yoga ustozi',
    qwenVoiceMarcus: 'Qisqa sozli obroʻ',
    qwenVoiceRoy: 'Kuldiruvchi toʻgʻridan-toʻgʻri ovoz',
    qwenVoicePeter: 'Xitoy dialekti ustasi',
    qwenVoiceSunny: 'Shirin Sichuan qizi',
    qwenVoiceEric: 'Cengdu jangchisi uslubi',
    qwenVoiceRocky: 'Hazilkash Gongkong',
    qwenVoiceKiki: 'Shirin Gongkonglik qiz',
    lang_auto: 'Avto aniqlash',
    lang_zh: '中文',
    lang_yue: '粤語',
    lang_en: 'English',
    lang_ja: '日本語',
    ...
    'lang_af-ZA': 'Afrikaans (Suid-Afrika)',
    'lang_uk-UA': 'Українська (Україна)',
    pdfSettings: 'PDF tahlil',
    pdfParsingSettings: 'PDF parserlash sozlamalari',
    pdfDescription:
      'Qo\'shimcha xususiyatlar bilan (matn yigish, rasm ajratgich, jadval yigish) ishlaydigan parser mexanizmini tanlang.',
    pdfProvider: 'PDF tahlilchisi',
    pdfFeatures: 'Qo\'llaniladigan xususiyatlar',
    pdfApiKey: 'API Key',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU bu - tijorat parser tizimi hisoblanib jadval, formulalar va maketlar kabi rivojlangan analiz xususiyatlariga ega.',
    mineruApiKeyRequired: 'Ishlatishdan avval MinerU API kalitini oling.',
    mineruWarning: 'Ogohlantirish',
    mineruCostWarning:
      'MinerU pullik servis bolib alohida chiqimlani chaqirishi mumkin. Pulli ulanish tafsilotlarini rasmiy saytidan organing.',
    enterMinerUApiKey: 'MinerU API kalitini kiritish',
    mineruLocalDescription:
      'MinerU maxalliy serverni kompiteryorizda tahliliy sozlamalari orqali tortilishiga yo\'l yaratadi.',
    mineruServerAddress: 'MinerU lokal server url-manzili (maslan: http://localhost:8080)',
    mineruApiKeyOptional: 'Ixtiyoriy ximoyalangan parolli serverlar tizimi qoshilganda.',
    optionalApiKey: '(Ixtiyoriy) API Key',
    featureText: 'Matn ajratuv',
    featureImages: 'Qiyofali Rasm izlovchisi',
    featureTables: 'Turli jadvallarni izlab qirqu',
    featureFormulas: 'Turli logarifm asosi formula bilimi',
    featureLayoutAnalysis: 'Stil qadish - tahlil (Maket)',
    featureMetadata: 'Metainfo kadi kalit soz',
    enableImageGeneration: 'AI rasm avto yaratilishini yoqing',
    imageGenerationDisabledHint:
      'Tizimni rasm generatsiyasiga ulash.',
    imageSettings: 'Rasm tizimi',
    imageSection: 'Matndan-rasmga',
    imageProvider: 'Tizim Provayderi (generatr)',
    imageModel: 'Tarmoq Modeli',
    providerSeedream: 'Seedream (ByteDance)',
    providerQwenImage: 'Qwen Image (Alibaba)',
    providerNanoBanana: 'Nano Banana (Gemini)',
    providerGrokImage: 'Grok Image (xAI)',
    providerLocalImage: 'Lokal tarmoq (SDXL-Turbo)',
    testImageGeneration: 'Tarmoq sinovi (generatsiyaga)',
    testImageConnectivity: 'Internet tezligini ishlash testi',
    imageConnectivitySuccess: 'Ulangan!',
    imageConnectivityFailed: 'Bog\'lanib bo\'lmadi!',
    imageTestSuccess: 'Test rasm togriligi natijaviyligi zor tushdi',
    imageTestFailed: 'Xatolik natijalarda topilmadi',
    imageTestPromptPlaceholder: 'Tarmoq sinovidan rasm ta\'rifi kiritsh',
    imageTestPromptDefault: 'Yoqimtoy mushuk stolda horgin poylab',
    imageGenerating: 'Qurilmoqda (Rasm)...',
    imageGenerationFailed: 'Bu qiyofadan chiqim ruxsat yoqi xatolik yuzaga keldi!',
    enableVideoGeneration: 'AI video yaratuvchini qo\'shing',
    videoGenerationDisabledHint:
      'Ishlaganda qisim va tushuntiruv jarayonii avto ish yuritishga komaklashuv',
    videoSettings: 'Video Tizimi',
    videoSection: 'Matndan->Video ijroga',
    videoProvider: 'Tizim Provayder',
    videoModel: 'Tarmoq Moderatori/Model',
    providerSeedance: 'Seedance (ByteDance)',
    providerKling: 'Kling (Kuaishou)',
    providerVeo: 'Veo (Google)',
    providerSora: 'Sora (OpenAI)',
    providerGrokVideo: 'Grok Video (xAI)',
    testVideoGeneration: 'Video izofini sinash',
    testVideoConnectivity: 'Tarmoqni sinash',
    videoConnectivitySuccess: 'Sinalgan - ulanilgan! (Tarmoq ishladi)',
    videoConnectivityFailed: 'Muvaffaqiyatsiz',
    testingConnection: 'Tarmoq orqali kutilmoqda...',
    videoTestSuccess: 'Test Muvaffaqiyatli',
    videoTestFailed: 'Test xatoga boy edi!',
    videoTestPromptDefault: 'Oyinda ketsin qiziq mushuk yurishda davom',
    videoGenerating: 'Video ishlanmoqda (1-2 minut)...',
    videoGenerationWarning: 'Sekin ishlab - davom 1-2 min',
    mediaRetry: 'Takror',
    mediaContentSensitive: 'Tekshiruv - axloqiy (qonuniy) to\'xtatilgan tahrir',
    mediaGenerationDisabled: 'Generatsiya (yaratish sozlamalarda yopilgan)',
    singleAgent: 'Yagona Agent rejimi',
    multiAgent: 'Ko\'p-Agentlar rejimi',
    selectAgents: 'Agent tanlash qutisi',
    noVisionWarning:
      'Joriy AI tizimi optik-tahlil tushunmeydi. Lekin bu xususiyatni slayd-komfortda tayyor sozlash mumkkn)',
    serverConfigured: 'Server tizim',
    serverConfiguredNotice:
      'Qoshimcha ulush/API lar Server tarmoqda ulanilib bolingan, agar siz boshqa API bermoqchi bolsangiz buni ichga to\'ldiring.',
    optionalOverride: 'Ixtiyoriy — bo\'sh qolsa Server kalitni davom etish ishlatadi',
    setupNeeded: 'Texnik sozlamani davom etiwni to\'g\'irlang',
    modelNotConfigured: 'Iltimos, avvaliga tizimda ishlash modeli tanlang',
    dangerZone: 'Xavfli Harakat',
    clearCache: 'Keshlash bazasini tozalash(Tozalash)',
    clearCacheDescription:
      'Ichki barcha xotiralar malumotlarni o\'chirish/ko\'rsatiladigan chat dialoglar / Ovozlar / rasmlar. Tiklab bolmewdi!',
    clearCacheConfirmTitle: 'Kesh larni barchasi tozalanadi/ochiriladi?',
    clearCacheConfirmDescription:
      'Ushbu harakat qat\'iyan malumotlar qaytalanib kelishina - ruxsatga tosqin qo\'yar/ o\'chirilib yuboriladi:',
    clearCacheConfirmItems:
      'Barcha sinf/stullar sahnasi, suhlatlar tarixi, Ovoz-Rasm jamlanmalari bazasi, Dasturdagi saqlangan afzal korimlar',
    clearCacheConfirmInput: 'Davom etish un tasdiq  "DELETE" kiriting',
    clearCacheConfirmPhrase: 'DELETE',
    clearCacheButton: 'Barchasini asoratlarin qaytmasdan o\'chirish',
    clearCacheSuccess: 'Keshlandi/o\'chirildi , Oyna yangilanish un jonatiladi',
    clearCacheFailed: 'Tozalab o\'chirib bo\'lmadi, Iltimos yana harakatlantiring',
    webSearchSettings: 'Internet qidiruv',
    webSearchApiKey: 'Tavily API Key',
    webSearchApiKeyPlaceholder: 'Tavily API-kalitini kirit',
    webSearchApiKeyPlaceholderServer: 'Server tarmoq-kaliti ulangan, o\'zgaritir',
    webSearchApiKeyHint: 'Internet ishlatishi tavily.com saytlaridan API ni izlab korin',
    webSearchBaseUrl: 'Markaziy baza (Url)',
    webSearchServerConfigured: 'Server Tavily-ga tayyor',
    optional: 'ixtiyoriy',
  },
  profile: {
    title: 'Profil',
    defaultNickname: 'Tolibi ilim',
    chooseAvatar: 'Avatar rasmini tayyorlang',
    uploadAvatar: 'Rasmni Yuklang',
    bioPlaceholder: 'O\'zingiz haqzningizdagi xulosalarni bera qolish...',
    avatarHint: 'Dars paytda avatar-rasmi korninish beryabdi.',
    fileTooLarge: 'Ruxsat (Limit) - 5mb gacha!',
    invalidFileType: 'Rasm turli tipini joylang',
    editTooltip: 'Oʻzgarish un!',
  },
  media: {
    imageCapability: 'Rasm generator',
    imageHint: 'Dars-ichida tayyori rasmini topilishi',
    videoCapability: 'Video generator',
    videoHint: 'Darsda tayyor ishlash video qish/qosh',
    ttsCapability: 'Ovoz Text->Speech yozuvli',
    ttsHint: 'AI - Ustoz darsini olib oqishdagi',
    asrCapability: 'Micro(Ovoz)li kiritma',
    asrHint: 'Micro ishi',
    provider: 'TIZIM-Provayder',
    model: 'Model',
    voice: 'Tizim-Ovoz',
    speed: 'Tezlik - Ritm',
    language: 'Til',
  ...
  auth: {
    ...
    loginDesc: 'Darslarni ko\'rish uchun tizimga kiring',
    ...
    emailTaken: 'Bu elektron pochta allaqachon ro\'yxatdan o\'tgan',
    registerSuccess: 'Hisob yaratildi, iltimos kiring',
    ...
    userName: 'Ism',
    userRole: 'Rol',
    userCreatedAt: 'Ro\'yxatdan o\'tgan',
    roleTeacher: 'O\'qituvchi',
    roleAdmin: 'Admin',
    deleteUser: 'Foydalanuvchini o\'chirish',
    deleteUserConfirm: 'Bu foydalanuvchini o\'chirishni istaysizmi?',
