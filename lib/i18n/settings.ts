...
export const settingsRuRU = {
  settings: {
    ...
    language: 'Язык',
    languageDesc: 'Выбери язык интерфейса',
    theme: 'Тема',
    themeDesc: 'Выбери светлую, тёмную тему или режим системы',
    themeOptions: {
      light: 'Светлая',
      dark: 'Тёмная',
    ...
    apiKey: 'API ключ',
    apiKeyDesc: 'Настрой свой API ключ',
    apiBaseUrl: 'Base URL API',
    apiBaseUrlDesc: 'Укажи адрес API endpoint',
    apiKeyRequired: 'API ключ не может быть пустым',
    model: 'Настройки модели',
    modelDesc: 'Настрой AI-модели',
    modelPlaceholder: 'Введи или выбери имя модели',
    ttsModel: 'TTS модель',
    ttsModelDesc: 'Настрой модели синтеза речи',
    ttsModelPlaceholder: 'Введи или выбери TTS модель',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    testConnection: 'Проверить подключение',
    testConnectionDesc: 'Проверить, работает ли текущая конфигурация API',
    testing: 'Проверяю...',
    ...
    providerNamePlaceholder: 'Например: мой OpenAI proxy',
    ...
    addNewModelDescription: 'Добавить новую конфигурацию модели',
    editModel: 'Редактировать модель',
    editModelDescription: 'Изменить конфигурацию модели и её возможности',
    modelId: 'ID модели',
    ...
    outputWindow: 'Вывод',
    contextWindowLabel: 'Размер контекстного окна',
    contextWindowPlaceholder: 'Например 128000',
    outputWindowLabel: 'Максимум output tokens',
    outputWindowPlaceholder: 'Например 4096',
    defaultBaseUrl: 'Base URL по умолчанию',
    providerIcon: 'URL иконки провайдера',
    requiresApiKey: 'Нужен API ключ',
    ...
    activeModel: 'Используемая модель',
    activeModelDescription: 'Выбери модель для AI-чата и генерации контента',
    selectModel: 'Выбрать модель',
    searchModels: 'Поиск моделей',
    noModelsFound: 'Подходящие модели не найдены',
    noModelsAvailable: 'Нет моделей для теста',
    noConfiguredProviders: 'Нет настроенных провайдеров',
    configureProvidersFirst: 'Сначала настрой провайдера слева',
    currentlyUsing: 'Сейчас используется',
    fetch: 'Получить',
    reset: 'Сбросить',
    resetToDefault: 'Сбросить к дефолту',
    resetToDefaultDescription: 'Вернуть список моделей по умолчанию, сохранив API ключ и Base URL',
    resetConfirmDescription:
      'Все кастомные модели будут удалены, а встроенный список восстановлен. API ключ и Base URL сохранятся.',
    confirmReset: 'Подтвердить сброс',
    resetSuccess: 'Настройки сброшены к дефолту',
    saveSuccess: 'Конфигурация сохранена',
    saveFailed: 'Не удалось сохранить, попробуй ещё раз',
    deleteProvider: 'Удалить провайдера',
    deleteProviderConfirm: 'Точно удалить этого провайдера?',
    cannotDeleteBuiltIn: 'Встроенного провайдера удалить нельзя',
    cannotDeleteBuiltInModel: 'Встроенную модель удалить нельзя',
    cannotEditBuiltInModel: 'Встроенную модель редактировать нельзя',
    connectionSuccess: 'Подключение успешно',
    connectionFailed: 'Подключение не удалось',
    howToUse: 'Как пользоваться',
    step1ConfigureProvider:
      'Открой раздел провайдеров моделей, выбери или добавь провайдера и задай API ключ, Base URL и остальное',
    step2SelectModel: 'Ниже выбери модель, которую хочешь использовать',
    step3StartUsing: 'После сохранения система будет работать с выбранной моделью',
    ...
    documentParser: 'Парсер документов',
    serverConfigured: 'Сервер',
    serverConfiguredNotice:
      'Для этого провайдера администратор уже настроил ключ на сервере. Можно использовать его сразу или ввести свой ключ поверх.',
    optionalOverride: 'Необязательно, оставь пустым для серверной конфигурации',
    setupNeeded: 'Требуется настройка',
    modelNotConfigured: 'Сначала выбери модель',
    dangerZone: 'Опасная зона',
    clearCache: 'Очистить локальный кэш',
    clearCacheDescription:
      'Удалить все локально сохранённые данные, включая classroom, историю чатов, аудио-кэш и настройки приложения. Действие необратимо.',
    clearCacheConfirmTitle: 'Точно очистить весь кэш?',
    clearCacheConfirmDescription:
      'Будут навсегда удалены следующие данные, восстановить их не получится:',
    clearCacheConfirmItems:
      'Classroom и сцены, История чатов, Кэш аудио и изображений, Настройки и предпочтения приложения',
    clearCacheConfirmInput: 'Введите «УДАЛИТЬ», чтобы продолжить',
    ...
    clearCacheFailed: 'Не удалось очистить кэш, попробуй ещё раз',
    webSearchSettings: 'Веб-поиск',
    webSearchApiKey: 'Tavily API ключ',
    webSearchApiKeyPlaceholder: 'Введи свой Tavily API ключ',
    webSearchApiKeyPlaceholderServer: 'Серверный ключ уже настроен, можно переопределить',
    webSearchApiKeyHint: 'Получи API ключ на tavily.com для веб-поиска',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'Серверный Tavily API ключ уже настроен',
    optional: 'Необязательно',
  },
  profile: {
    title: 'Профиль',
    defaultNickname: 'Студент',
    chooseAvatar: 'Выбрать аватар',
    uploadAvatar: 'Загрузить',
    bioPlaceholder: 'Расскажи немного о себе, и AI-преподаватель подстроит уроки под твой фон...',
    avatarHint: 'Твой аватар будет виден в classroom-обсуждениях и чатах',
    fileTooLarge: 'Изображение слишком большое, выбери файл меньше 5 МБ',
    invalidFileType: 'Выбери файл изображения',
    editTooltip: 'Нажми, чтобы отредактировать профиль',
  },
  media: {
    imageCapability: 'Генерация изображений',
    imageHint: 'Генерировать изображения в слайдах',
    videoCapability: 'Генерация видео',
    videoHint: 'Генерировать видео в слайдах',
    ttsCapability: 'Синтез речи',
    ttsHint: 'AI-преподаватель говорит вслух',
