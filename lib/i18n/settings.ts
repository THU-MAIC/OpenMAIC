export const settingsZhCN = {
  settings: {
    ...
    webSearchApiKeyPlaceholder: '输入搜索引擎的 API Key',
    webSearchApiKeyPlaceholderServer: '已配置服务端密钥，可选填覆盖',
    webSearchApiKeyHint: '输入搜索引擎的 API Key，用于网络搜索',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: '服务端已配置搜索引擎 API Key',
    webSearchNoApiKeyNeeded: '此搜索引擎无需 API Key，免费使用',
    optional: '可选',
  },
  profile: {
    title: '个人资料',
...
export const settingsEnUS = {
  settings: {
    ...
    webSearchApiKey: 'API Key',
    webSearchApiKeyPlaceholder: 'Enter your search provider API Key',
    webSearchApiKeyPlaceholderServer: 'Server key configured, optionally override',
    webSearchApiKeyHint: 'Enter an API key for the selected search provider',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'Server-side search API key is configured',
    webSearchNoApiKeyNeeded: 'This search provider is free and requires no API key',
    optional: 'Optional',
  },
  profile: {
    title: 'Profile',
