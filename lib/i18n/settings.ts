...
export const settingsViVN = {
  settings: {
    ...
    theme: 'Giao diện',
    themeDesc: 'Chọn chế độ giao diện (Sáng/Tối/Hệ thống)',
    themeOptions: {
      light: 'Sáng',
      dark: 'Tối',
      system: 'Hệ thống',
    ...
    apiKey: 'API Key',
    apiKeyDesc: 'Cấu hình API key của bạn',
    apiBaseUrl: 'API Base URL',
    apiBaseUrlDesc: 'Cấu hình đường dẫn URL gốc của API',
    apiKeyRequired: 'API key không được để trống',
    model: 'Cấu hình mô hình',
    modelDesc: 'Cấu hình mô hình AI',
    modelPlaceholder: 'Nhập hoặc chọn tên mô hình',
    ttsModel: 'Mô hình TTS',
    ttsModelDesc: 'Cấu hình mô hình chuyển văn bản thành giọng nói (TTS)',
    ttsModelPlaceholder: 'Nhập hoặc chọn tên mô hình TTS',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    availableModels: 'Các mô hình khả dụng',
    modelSelectedViaVoice: 'Mô hình được xác định tự động bằng giọng nói',
    testConnection: 'Kiểm tra kết nối',
    testConnectionDesc: 'Kiểm tra cấu hình API hiện tại có hoạt động không',
    testing: 'Đang kiểm tra...',
    agentSettings: 'Cài đặt Tác nhân',
    agentSettingsDesc:
      'Chọn các tác nhân (agent) tham gia cuộc trò chuyện. Chọn 1 cho chế độ đơn tác nhân, nhiều cho chế độ tương tác đa tác nhân.',
    agentMode: 'Chế độ Tác nhân',
    agentModePreset: 'Mặc định',
    agentModeAuto: 'Tự động tạo',
    agentModeAutoDesc: 'AI sẽ tự động tạo vai trò phù hợp',
    autoAgentCount: 'Số lượng tác nhân',
    autoAgentCountDesc: 'Số lượng tác nhân sẽ tự động tạo (bao gồm giáo viên)',
    atLeastOneAgent: 'Vui lòng chọn ít nhất 1 tác nhân',
    singleAgentMode: 'Chế độ Đơn Tác Nhân',
    directAnswer: 'Trả lời trực tiếp',
    multiAgentMode: 'Chế độ Đa Tác Nhân',
    agentsCollaborating: 'Thảo luận hợp tác',
    agentsCollaboratingCount: 'Đã chọn {count} tác nhân để thảo luận',
    maxTurns: 'Số vòng thảo luận tối đa',
    maxTurnsDesc:
      'Lượt tương tác tối đa giữa các tác nhân (khi một tác nhân thực hiện hành động và trả lời tính là 1 lượt)',
    priority: 'Độ ưu tiên',
    actions: 'Hành động',
    actionCount: '{count} hành động',
    selectedAgent: 'Tác nhân đã chọn',
    selectedAgents: 'Tác nhân đã chọn',
    required: 'Bắt buộc',
    agentNames: {
      'default-1': 'Giáo Viên AI',
      'default-2': 'Trợ Giảng AI',
      'default-3': 'Người Vui Tính',
      'default-4': 'Học Sinh Tò Mò',
      'default-5': 'Người Ghi Chép',
      'default-6': 'Nhà Tư Tưởng',
    },
    agentRoles: {
      teacher: 'Giáo viên',
      assistant: 'Trợ giảng',
    ...
    agentDescriptions: {
      'default-1': 'Giảng viên chính, diễn giải mạch lạc và có hệ thống',
      'default-2': 'Hỗ trợ việc học và giải thích các điểm chính',
      'default-3': 'Mang lại sự hài hước và năng lượng cho bài giảng',
      'default-4': 'Luôn tò mò, thích hỏi tại sao và làm thế nào',
      'default-5': 'Chăm chỉ ghi chép và tổ chức lại kiến thức',
      'default-6': 'Suy nghĩ sâu vào bản chất của bất kỳ chủ đề nào',
    },
    close: 'Đóng',
    save: 'Lưu',
    // Provider settings
    providers: 'LLM',
    addProviderDescription: 'Thêm nhà cung cấp mô hình AI (LLM) để mở rộng các mô hình bạn có',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    providerTypes: {
      ...
      anthropic: 'Giao thức Claude',
      google: 'Giao thức Gemini',
    },
    modelCount: 'mô hình',
    ...
    documentParser: 'Bộ phân tích tài liệu',
    conversationSettings: 'Trò chuyện',
    keyboardShortcuts: 'Phím tắt',
    generalSettings: 'Chung',
    systemSettings: 'Hệ thống',
    addProvider: 'Thêm',
    importFromClipboard: 'Nhập từ Clipboard',
    apiSecret: 'API Key',
    apiHost: 'Base URL',
    requestUrl: 'Request URL',
    models: 'Các mô hình',
    ...
    capabilities: {
      vision: 'Thị giác',
      tools: 'Công cụ',
      streaming: 'Truyền (Stream)',
    },
    contextWindow: 'Ngữ cảnh',
    contextShort: 'ctx',
    outputWindow: 'Giới hạn Output',
    // Provider management
    addProviderButton: 'Thêm',
    addProviderDialog: 'Thêm nhà cung cấp mô hình',
    providerName: 'Tên',
    providerNamePlaceholder: 'VD: Proxy OpenAI Của Tôi',
    providerNameRequired: 'Vui lòng nhập tên nhà cung cấp',
    providerApiMode: 'Chế độ API',
    apiModeOpenAI: 'Giao thức OpenAI',
    apiModeAnthropic: 'Giao thức Claude',
    apiModeGoogle: 'Giao thức Gemini',
    defaultBaseUrl: 'Base URL mặc định',
    providerIcon: 'URL icon nhà cung cấp',
    requiresApiKey: 'Yêu cầu API Key',
    deleteProvider: 'Xóa nhà cung cấp',
    deleteProviderConfirm: 'Bạn có chắc chắn muốn xóa nhà cung cấp này không?',
    cannotDeleteBuiltIn: 'Không thể xóa nhà cung cấp mặc định',
    resetToDefault: 'Đặt lại về mặc định',
    resetToDefaultDescription:
      'Khôi phục danh sách mô hình về cấu hình gốc (API Key và Base URL sẽ giữ nguyên)',
    resetConfirmDescription:
      'Thao tác này sẽ xóa tất cả các mô hình tùy chỉnh và khôi phục mô hình mặc định. API Key và Base URL vẫn giữ.',
    confirmReset: 'Xác nhận đặt lại',
    resetSuccess: 'Đặt lại về mặc định thành công',
    saveSuccess: 'Đã lưu cấu hình',
    saveFailed: 'Lưu thất bại, vui lòng thử lại',
    cannotDeleteBuiltInModel: 'Không thể xóa cấu hình mặc định',
    cannotEditBuiltInModel: 'Không thể chỉnh mô hình mặc định',
    modelIdRequired: 'Vui lòng điền model ID',
    noModelsAvailable: 'Không có mô hình để thử nghiệm',
    providerMetadata: 'Siêu dữ liệu nhà cung cấp',
    // Model editing
    editModel: 'Chỉnh sửa mô hình',
    editModelDescription: 'Điều chỉnh năng lực và cấu hình mô hình',
    addNewModel: 'Mô hình mới',
    addNewModelDescription: 'Thêm cấu hình của máy chủ',
    modelId: 'Model ID',
    modelIdPlaceholder: 'VD: gpt-4o',
    modelName: 'Tên hiển thị',
    modelNamePlaceholder: 'Tùy chọn',
    modelCapabilities: 'Chức năng',
    advancedSettings: 'Nâng cao',
    contextWindowLabel: 'Giới hạn Ngữ cảnh (Tokens)',
    contextWindowPlaceholder: 'VD: 128000',
    outputWindowLabel: 'Giới hạn Output tối đa',
    outputWindowPlaceholder: 'VD: 4096',
    testModel: 'Thử nghiệm mô hình',
    deleteModel: 'Xóa',
    cancelEdit: 'Hủy',
    saveModel: 'Lưu',
    modelsManagementDescription:
      'Quản lý danh sách mô hình của đối tác này. Để phân bổ mô hình kích hoạt, vào phần Cài đặt Chung.',
    // General settings
    howToUse: 'Cách sử dụng',
    step1ConfigureProvider:
      'Vào phần "LLM", chọn hoặc thêm một nhà cung cấp gốc, thiết lập thông tin liên kết (API key, Base URL, v.v.)',
    step2SelectModel: 'Chọn mô hình dùng trong mục "Mô hình Hiện tại" phía dưới',
    step3StartUsing: 'Sau khi lưu, hệ thống sẽ sử dụng mô hình bạn chọn',
    activeModel: 'Mô hình đang kích hoạt',
    activeModelDescription: 'Vui lòng chọn mô hình AI chính bạn muốn dùng để tạo bài',
    selectModel: 'Chọn mô hình',
    searchModels: 'Tìm mô hình',
    noModelsFound: 'Không có thông tin mô hình',
    noConfiguredProviders: 'Chưa có nhà cung cấp được cấu hình',
    configureProvidersFirst:
      'Vui lòng cấu hình các nhà cung cấp thông tin tại bộ phận "LLM" ở cột bên trái trước',
    currentlyUsing: 'Đang dùng',
    // TTS settings
    ttsSettings: 'Chuyển văn bản thành giọng nói',
    // ASR settings
    asrSettings: 'Nhận dạng giọng nói',
    // Audio settings (legacy)
    audioSettings: 'Cấu hình âm thanh',
    ttsSection: 'Văn bản thành Giọng nói (TTS)',
    asrSection: 'Nhận dạng Giọng nói tự động (ASR)',
    ttsDescription: 'TTS (Text-to-Speech) - Đọc văn bản lên thành lời',
    asrDescription: 'ASR (Automatic Speech Recognition) - Chuyển lời nói sang chữ',
    enableTTS: 'Kích hoạt Văn bản thành giọng nói',
    ttsEnabledDescription: 'Âm thanh bài giảng AI sẽ được xuất sinh khi đang tạo lớp học',
    ttsVoiceConfigHint:
      'Bạn cũng có thể điều chỉnh giọng nói từng nhân vật ở trang chủ bằng cách xem "Đội hình Lớp học"',
    enableASR: 'Kích hoạt dịch vụ Nhận diện giọng nói',
    asrEnabledDescription: 'Người dùng lúc học có thể thu âm qua micro để trò chuyện',
    ttsProvider: 'Dịch vụ cung cấp TTS',
    ttsLanguageFilter: 'Bộ lọc ngôn ngữ',
    ...
    doubaoAppId: 'App ID',
    doubaoAccessKey: 'Access Key',
    asrProvider: 'Dịch vụ cung cấp ASR',
    asrLanguage: 'Ngôn ngữ của ASR',
    asrBaseUrl: 'Base URL',
    asrApiKey: 'API Key',
    enterApiKey: 'Ghi lại Key API',
    enterCustomBaseUrl: 'Ghi mã Base URL cá nhân',
    browserNativeNote: 'Giao thức Native của Trình duyệt đều hoàn toàn miễn phí và tốt sẵn',
    // Audio provider names
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerGLMTTS: 'GLM TTS',
    providerQwenTTS: 'Qwen TTS (Chuyên Gia Alibaba Cloud)',
    providerDoubaoTTS: 'Doubao TTS 2.0 (Volcengine)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerMiniMaxTTS: 'MiniMax TTS',
    ...
    providerQwenASR: 'Qwen ASR (Alibaba Cloud Bailian)',
    providerUnpdf: 'unpdf (Mặc định được hỗ trợ)',
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'Công cụ hỗ trợ gốc không cần cấu hình cũng không tính thêm khoản phí nào',
    testTTS: 'Phát thanh mẫu âm thanh',
    testASR: 'Phát thanh mẫu giọng nói',
    testSuccess: 'Phát thành công',
    testFailed: 'Không thể phát thành công',
    ttsTestText: 'Thử lại phần tạo dòng lệnh TTS',
    ttsTestSuccess: 'Đã phát đoạn âm thanh tương thích TTS',
    ttsTestFailed: 'Gặp sự cố TTS',
    asrTestSuccess: 'ASR đã chạy thành công',
    asrTestFailed: 'Không thành công tạo bản phân định âm thanh',
    asrResult: 'Tóm lược âm thanh',
    asrNotSupported: 'Trình duyệt không cho phép Truy vấn ASR API',
    browserTTSNotSupported: 'Không có cách nào tạo ra giao thức TTS API bằng trình phát Web này',
    browserTTSNoVoices: 'Không xác định dạng nội dung TTS',
    microphoneAccessDenied: 'Micro từ thiết bị chưa cấp quyền',
    microphoneAccessFailed: 'Không xử lý cho thiết bị vào dạng micro',
    asrResultPlaceholder: 'Khi đã ghi âm bằng máy xong phần nội dung sẽ chạy ra màn hình',
    useThisProvider: 'Sử dụng Tùy chọn',
    fetchVoices: 'Cập nhật lại Danh sách',
    fetchingVoices: 'Đang tải về...',
    voicesFetched: 'Tải Xong',
    fetchVoicesFailed: 'Tải thất bại xin gặp lại',
    voiceApiKeyRequired: 'Bạn thiếu thông tin API',
    voiceBaseUrlRequired: 'Điền liên kết URL Cấp',
    ttsTestTextPlaceholder: 'Thử kiểm lại',
    ttsTestTextDefault: 'Cảm ơn, đây là phần giới thiệu âm trường mẫu.',
    startRecording: 'Luôn ghi',
    stopRecording: 'Dừng ghi',
    recording: 'Kỳ hoạt ghi âm...',
    transcribing: 'Đang định cấu trúc thành văn bản...',
    transcriptionResult: 'Bản phân giải',
    noTranscriptionResult: 'Ghi chưa cấu trúc xong',
    baseUrlOptional: 'Base URL (Tự điền)',
    defaultValue: 'Nguyên văn',
    // TTS Voice descriptions (OpenAI)
    voiceMarin: 'Được ưu tiên chọn - Chất lượng hạng A',
    voiceCedar: 'Được ưu tiên chọn - Mềm và dẻo',
    voiceAlloy: 'Tầm trung - Trầm ấm',
    voiceAsh: 'Phù hợp công sở',
    voiceBallad: 'Hùng ca uy quyền',
    voiceCoral: 'Giọng thân thiện, hài hòa',
    voiceEcho: 'Giọng nam tính nổi loạn',
    voiceFable: 'Kiểu như kể chuyện cho trẻ em',
    voiceNova: 'Giọng nữ sắc và ngọt',
    voiceOnyx: 'Nam trầm nhất',
    voiceSage: 'Âm sắc của người thông thái',
    voiceShimmer: 'Giọng nữ uyển chuyển',
    voiceVerse: 'Giọng văn nói liên tưởng',
    // TTS Voice descriptions (GLM)
    glmVoiceTongtong: 'Giọng mặc định',
    glmVoiceChuichui: 'Giọng tên Chuichui',
    glmVoiceXiaochen: 'Giọng tên Xiaochen',
    glmVoiceJam: 'Giọng kiểu Jam',
    glmVoiceKazi: 'Giọng kiểu Kazi',
    glmVoiceDouji: 'Giọng kiểu Douji',
    glmVoiceLuodo: 'Giọng tên Luodo',
    // TTS Voice descriptions (Qwen)
    qwenVoiceCherry: 'Sôi nổi, trẻ và nhẹ nhàng',
    qwenVoiceSerena: 'Dễ nhận dạng và nữ tính',
    qwenVoiceEthan: 'Sôi động và dứt khoát',
    qwenVoiceChelsie: 'Theo kiểu virtual girlfriend',
    qwenVoiceMomo: 'Lan truyền năng lượng cao và tích cực',
    qwenVoiceVivian: 'Ngổ tiếng con nít dễ thương',
    qwenVoiceMoon: 'Tự tại và ngầu',
    qwenVoiceMaia: 'Tri thức, có học vấn thâm sâu',
    qwenVoiceKai: 'Thư giãn nghe SPA',
    qwenVoiceNofish: "Không biết đọc các giọng điệu cao siêu",
    qwenVoiceBella: "Cô nương nhép dễ dãi",
    qwenVoiceJennifer: 'Giọng tiêu chuẩn cho thương mại quốc tế',
    qwenVoiceRyan: 'Nhịp độ nói luyến thoắng kịch tính',
    qwenVoiceKaterina: 'Mạch liên hồi mạnh nhịp âm nhạc',
    qwenVoiceAiden: 'Đam mê nấu ăn tiếng Mỹ cực xịn',
    qwenVoiceEldricSage: 'Đề nén cho cụ già thông thạo nhiều lẽ phải',
    qwenVoiceMia: 'Dịu và nhẹ',
    qwenVoiceMochi: 'Thông minh con lớn lộng lẫy',
    qwenVoiceBellona: 'Tự dưng hăng hái vĩ đại',
    qwenVoiceVincent: 'Đeo đai đen trong cuộc tình qua thời hoàng kim',
    qwenVoiceBunny: 'Loli đáng yêu vô độ',
    qwenVoiceNeil: 'Khung thông tin kênh phát thanh',
    qwenVoiceElias: 'Dành làm giọng chuyên gia phân tích',
    qwenVoiceArthur: 'Phong cách chậm rải nhẹ nhàng',
    qwenVoiceNini: 'Mềm như vỏ bánh bao nước',
    qwenVoiceEbona: 'Bảo thạch rỉ sét bí ẩn',
    qwenVoiceSeren: 'Mang đến tiếng ru ru dịu em bé',
    qwenVoicePip: 'Góc tinh thần như con trẻ rạng ngời',
    qwenVoiceStella: 'Hiền lành nhưng sẵn sàng rực rỡ nếu bộc lộ',
    qwenVoiceBodega: 'Chú bồi bàn nước láng giềng nhiệt liệt',
    qwenVoiceSonrisa: 'Niềm nở chia sẻ của cư ngụ nam Mỹ Châu',
    qwenVoiceAlek: 'Đắm mình của không phân bổ lạnh',
    qwenVoiceDolce: 'Lạ và quen của các người chú Ý gia dụng',
    qwenVoiceSohee: 'Vui vẻ như nữ unnie từ xứ Kim Chi',
    qwenVoiceOnoAnna: 'Cô gái trẻ vui tươi thời niên thiếu',
    qwenVoiceLenn: 'Trưởng thành thích ăn mặc thời trang có gout Đức',
    qwenVoiceEmilien: 'Ông anh trai từ dòng pháp lai tình ý',
    qwenVoiceAndre: 'Cử chỉ thanh khiết có tính thu hút phái nữ',
    qwenVoiceRadioGol: 'Người sáng tạo thơ bóng đá!',
    qwenVoiceJada: 'Mợ Thượng Hải nhạy bén cá tính',
    qwenVoiceDylan: 'Tài tử mang dòng máu Bắc Kinh rộn rã',
    qwenVoiceLi: 'Đóng vai dạy tư thế thiền Yoga đỉnh cao',
    qwenVoiceMarcus: 'Khí chất cứng nhắc mà đầy sự thật',
    qwenVoiceRoy: 'Giao thoa đầy kếu ngạo dí dỏm chuẩn Đài Loan',
    qwenVoicePeter: 'Độc quyền Tinh Lộc mậu dịch',
    qwenVoiceSunny: 'Say lị đầy tính xảo ngọt xuyên tim',
    ...
    lang_cy: 'Cymraeg',
    // BCP-47 format language codes (for Web Speech API)
    'lang_zh-CN': 'Tiếng Trung (Giản thể, TQ)',
    'lang_zh-TW': 'Tiếng Trung (Phồn thể, Đài Loan)',
    'lang_zh-HK': 'Tiếng Quảng Đông (Hong Kong)',
    'lang_yue-Hant-HK': 'Tiếng Quảng Đông (Phồn thể)',
    'lang_en-US': 'Tiếng Anh (Mỹ)',
    'lang_en-GB': 'Tiếng Anh (Anh)',
    'lang_en-AU': 'Tiếng Anh (Úc)',
    'lang_en-CA': 'Tiếng Anh (Canada)',
    'lang_en-IN': 'Tiếng Anh (Ấn Độ)',
    'lang_en-NZ': 'Tiếng Anh (New Zealand)',
    'lang_en-ZA': 'Tiếng Anh (Nam Phi)',
    'lang_ja-JP': 'Tiếng Nhật',
    'lang_ko-KR': 'Tiếng Hàn',
    'lang_de-DE': 'Tiếng Đức',
    'lang_fr-FR': 'Tiếng Pháp',
    'lang_es-ES': 'Tiếng Tây Ban Nha (TBN)',
    'lang_es-MX': 'Tiếng Tây Ban Nha (Mexico)',
    'lang_es-AR': 'Tiếng Tây Ban Nha (Argentina)',
    'lang_es-CO': 'Tiếng Tây Ban Nha (Colombia)',
    'lang_it-IT': 'Tiếng Ý',
    'lang_pt-BR': 'Tiếng Bồ Đào Nha (Brazil)',
    'lang_pt-PT': 'Tiếng Bồ Đào Nha (BĐN)',
    'lang_ru-RU': 'Tiếng Nga',
    'lang_nl-NL': 'Tiếng Hà Lan',
    'lang_pl-PL': 'Tiếng Ba Lan',
    'lang_cs-CZ': 'Tiếng Séc',
    'lang_da-DK': 'Tiếng Đan Mạch',
    'lang_fi-FI': 'Tiếng Phần Lan',
    'lang_sv-SE': 'Tiếng Thụy Điển',
    'lang_no-NO': 'Tiếng Na Uy',
    'lang_tr-TR': 'Tiếng Thổ Nhĩ Kỳ',
    'lang_el-GR': 'Tiếng Hy Lạp',
    'lang_hu-HU': 'Tiếng Hungary',
    'lang_ro-RO': 'Tiếng Romania',
    'lang_sk-SK': 'Tiếng Slovak',
    'lang_bg-BG': 'Tiếng Bulgaria',
    'lang_hr-HR': 'Tiếng Croatia',
    'lang_ca-ES': 'Tiếng Catalan',
    'lang_ar-SA': 'Tiếng Ả Rập (Saudi)',
    'lang_ar-EG': 'Tiếng Ả Rập (Ai Cập)',
    'lang_he-IL': 'Tiếng Do Thái',
    'lang_hi-IN': 'Tiếng Hindi',
    'lang_th-TH': 'Tiếng Thái',
    'lang_vi-VN': 'Tiếng Việt',
    'lang_id-ID': 'Tiếng Indonesia',
    'lang_ms-MY': 'Tiếng Mã Lai',
    'lang_fil-PH': 'Tiếng Philippines',
    'lang_af-ZA': 'Tiếng Afrikaans',
    'lang_uk-UA': 'Tiếng Ukraina',
    // PDF settings
    pdfSettings: 'Phân tích tài liệu PDF',
    pdfParsingSettings: 'Thiết lập lấy dữ liệu PDF',
    pdfDescription:
      'Chọn hệ thống lấy tài liệu dạng văn bản lẫn biểu mẫu hình ảnh và số từ bên trong',
    pdfProvider: 'Trình đọc PDF',
    pdfFeatures: 'Tính năng hỗ trợ',
    pdfApiKey: 'API Key',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU là công cụ thương mại phục vụ chức năng phân tích nâng cao đối với file PDF khó dùng.',
    mineruApiKeyRequired: 'Bạn phải có Key bản quyền tải về tại website MinerU.',
    mineruWarning: 'Cảnh báo',
    mineruCostWarning:
      'MinerU tính phí dựa vào số lượt xem lấy thông tin dữ liệu. Mời check giá cả tại MinerU web.',
    enterMinerUApiKey: 'Nhập API key MinerU',
    mineruLocalDescription:
      'Có thể cung cấp bằng localhost của máy của bạn, sau đó thiết lập bằng link vào đây.',
    mineruServerAddress: 'Đia chỉ dạng Web API Service cục bộ hoặc từ xa máy con (http://...)',
    mineruApiKeyOptional: 'Thích hợp khi cấu hình khóa bảo mật tại Node Server',
    optionalApiKey: 'Tùy chọn cho API Key',
    featureText: 'Trích xuất chữ viết',
    featureImages: 'Trích xuất Hình',
    featureTables: 'Lọc biểu mẫu',
    featureFormulas: 'Nhận dạng Hàm/Công thức',
    featureLayoutAnalysis: 'Ghi chú đánh giá layout',
    featureMetadata: 'Tính toán dữ liệu File',
    // Image Generation settings
    enableImageGeneration: 'Mở tính năng vẽ tranh 2D ảo AI',
    imageGenerationDisabledHint:
      'Khi đã cấp quyền thì tranh vẽ 2D ảo sẽ tự động bồi chung vào khoá học',
    imageSettings: 'Năng lực làm Tranh và Ảnh (AI Generation)',
    imageSection: 'Vẽ (Text To Image)',
    imageProvider: 'Dịch vụ vẽ khung',
    imageModel: 'Mô hình',
    providerSeedream: 'Seedream (ByteDance)',
    providerQwenImage: 'Qwen Image (Alibaba)',
    providerNanoBanana: 'Nano Banana (Gemini)',
    providerMiniMaxImage: 'MiniMax Image',
    providerGrokImage: 'Grok Image (xAI)',
    testImageGeneration: 'Xác minh AI tạo ảnh',
    testImageConnectivity: 'Kiểm duyệt',
    imageConnectivitySuccess: 'Hệ thống nhận liên lạc ok',
    imageConnectivityFailed: 'Không nhận API',
    imageTestSuccess: 'Bấm phát hình ngay thành công',
    imageTestFailed: 'Không lên được bản phác họa',
    imageTestPromptPlaceholder: 'Cho mô phỏng vẽ...',
    imageTestPromptDefault: 'Tranh ảnh vẽ siêu thực về bạn mèo ngoan cực xinh trên chiếc Laptop',
    imageGenerating: 'Phác thảo bản thiết kế...',
    imageGenerationFailed: 'Thất bại khi bồi xuất',
    // Video Generation settings
    enableVideoGeneration: 'Bật khả năng Video AI thế hệ',
    videoGenerationDisabledHint:
      'Hệ thống AI Video Engine tự động thêm vào dự án khi đăng ký',
    videoSettings: 'Năng lực thiết kế Video (AI Generation)',
    videoSection: 'Tạo Video theo Văn Học (TTV)',
    videoProvider: 'Nhà cung cấp AI Engine',
    videoModel: 'Cấu hình Engine',
    providerSeedance: 'Seedance (ByteDance)',
    providerKling: 'Kling (Kuaishou)',
    providerVeo: 'Veo (Google)',
    providerSora: 'Sora (OpenAI)',
    providerMiniMaxVideo: 'MiniMax Video',
    providerGrokVideo: 'Grok Video (xAI)',
    testVideoGeneration: 'Bắt đầu bấm thử',
    testVideoConnectivity: 'Kết nối cho server test',
    videoConnectivitySuccess: 'Ping nhận phản hồi ổn',
    videoConnectivityFailed: 'Không gọi về máy chủ Engine API',
    testingConnection: 'Hệ thống load thử...',
    videoTestSuccess: 'Qua bài đăng ký tạo Video API Test',
    videoTestFailed: 'Test kết thúc bằng 1 lỗi',
    videoTestPromptDefault: 'Một chú mèo đi lại trên bàn',
    videoGenerating: 'Đang khởi động tạo nền video AI (1-2 Phút)...',
    videoGenerationWarning: 'Trình AI làm video mất cỡ bằng vài phút để gánh đủ khung hình nên lưu lại chút đợi nhe',
    mediaRetry: 'Gỡ Lỗi và Gọi lại',
    mediaContentSensitive: 'Đã chặn tính năng xử video có nội dung xấu',
    mediaGenerationDisabled: 'Đã bị cấm xài trình này ở trong Hệ Thống Cài Đặt',
    // Agent settings (kept with main settings block above)
    singleAgent: 'Đơn Tác nhân',
    multiAgent: 'Đa Tác nhân (Lớp học)',
    selectAgents: 'Vai diễn',
    noVisionWarning:
      'Ghi nhận rằng LLM thiếu khả năng nhận dạng Vision nhưng nó vẫn rải hình ảnh trên bản vẽ vì không kiểm hóa rõ ràng chất lượng cho bạn',
    // Server provider configuration
    serverConfigured: 'Phía Server Backend',
    serverConfiguredNotice:
      'Admin hiện có định dạng API này sẵn thay cho API cá nhân. Tự xài Key cá nhân bằng bỏ mã vào bên trên để ưu tiên xài.',
    optionalOverride: 'Tùy chọn - nếu bỏ trống thì ứng dụng xài mã của Backend Cty phân bố',
    // Access code
    setupNeeded: 'Chưa đủ điều kiện kích hoạt ứng dụng, khai báo bổ sung cài đặt',
    modelNotConfigured: 'Chọn 1 engine để hoàn thành phần khai báo',
    // Clear cache
    dangerZone: 'Khu vực Xóa rác',
    clearCache: 'Toàn bộ nội bộ xoá Cache',
    clearCacheDescription:
      'Dọn tất cả dữ liệu ghi nhớ của bạn bao gồm quá trình, tài liệu cache, và sở thích. Dữ liệu một đi không trở về.',
    clearCacheConfirmTitle: 'Rõ là đang dọn trắng xóa ứng dụng nội bộ phải không?',
    clearCacheConfirmDescription:
      'Bạn đang xoá cả vũng thông tin mà sau này chẳng kiếm đâu lại được đồ cổ:',
    clearCacheConfirmItems:
      'Bảng mô phỏng ghi âm, nhật ký nhắn tin lớp học qua lại, bài học ghi chú, v.v.',
    clearCacheConfirmInput: 'Bạn nhập "XOA" vào để máy đi đổ rác',
    clearCacheConfirmPhrase: 'XOA',
    clearCacheButton: 'Phá hũi toàn dữ liệu bên trong của máy trạm',
    clearCacheSuccess: 'Thành công xong màn dọn rác. Máy tự động reload',
    clearCacheFailed: 'Toang, không xoá hết được do có vài dữ liệu đang ghi chưa xong',
    // Web Search settings
    webSearchSettings: 'Tìm kiếm mạng lưới Data web',
    webSearchApiKey: 'Tavily API Key',
    webSearchApiKeyPlaceholder: 'Cho cái Key Tavily mà bạn mượn',
    webSearchApiKeyPlaceholderServer: 'Chạy key có từ Server bên trên trừ khi bạn muốn nạp riêng',
    webSearchApiKeyHint: 'Sang trang tavily.com đăng ký một thẻ chìa khoá API Key về đây đăng ký lệnh cho AI',
    webSearchBaseUrl: 'Đường dẫn Base URL',
    webSearchServerConfigured: 'Server Cty đã làm thủ tục để bật được Tavily Key cho bạn',
    optional: 'Tùy chọn',
  },
  profile: {
    title: 'Hồ sơ cá nhân',
    defaultNickname: 'Học sinh',
    chooseAvatar: 'Thay Avatar',
    uploadAvatar: 'Tải File ảnh',
    bioPlaceholder: 'Hãy giới thiệu tí chuyện hay về bạn, những giáo viên ảo sẽ giảng học bám theo mô phỏng của bạn...',
    avatarHint: 'Người thật và những vị giáo viên khác sẽ thấy rõ hình đại diện này trong Lớp Học Tương tác',
    fileTooLarge: 'Vui lòng chọn hình nào nhẹ dưới kích thước 5MB',
    invalidFileType: 'Cho mình xin hình gốc nghen',
    editTooltip: 'Bấm sửa',
  },
  media: {
    imageCapability: 'Tạo Hình',
    imageHint: 'Tìm ảnh trang chiếu',
    videoCapability: 'Tạo Video',
    videoHint: 'Nhúng Clip trang chiếu',
    ttsCapability: 'Phát Động Tiếng (TTS)',
    ttsHint: 'LLM Cô/Thầy dùng Voice',
    asrCapability: 'Dịch Thoại Thành Chữ (ASR)',
    asrHint: 'Cho nói micro trên web',
    provider: 'Provider',
    model: 'Engine LLM Mô Hình',
    voice: 'Giọng nói điệu',
    speed: 'Tốc âm',
    language: 'Ngôn Lệnh',
  },
} as const;
