...
export interface StylePreferences {
  ...
  language: string; // 'zh-CN', 'en-US', 'es-MX'
}
...
export interface UserRequirements {
  ...
  language: 'zh-CN' | 'en-US' | 'es-MX'; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'zh-CN' | 'en-US' | 'es-MX'; // Generation language (inherited from requirements)
