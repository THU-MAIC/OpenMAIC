...
export interface UserRequirements {
  ...
  language: 'zh-CN' | 'en-US' | 'ja-JP' | 'de-DE'; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'zh-CN' | 'en-US' | 'ja-JP' | 'de-DE'; // Generation language (inherited from requirements)
  ...
  pblConfig?: {
    ...
    targetSkills: string[];
    issueCount?: number;
    language: 'zh-CN' | 'en-US' | 'ja-JP' | 'de-DE';
  };
}
