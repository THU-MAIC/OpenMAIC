...
export function buildDirectorPrompt(
  ...
  originalMessages?: StatelessChatRequest['messages'],
): string {
...
`
  ...
  const openStudentQuestionSection = buildOpenStudentQuestionSection(originalMessages);
 ...
 */
function buildOpenStudentQuestionSection(messages?: StatelessChatRequest['messages']): string {
