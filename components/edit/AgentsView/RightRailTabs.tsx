...
/**
 * Tabbed right rail: "Edit with AI" | "Classroom roster"
 *
 ...
 * the the roster tab renders AgentRosterPanel. Both are kept mounted so state
 ...
 * falls back to the roster (which is always available, as agents are stage-level).
 */
