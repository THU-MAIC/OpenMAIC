    ...
    >
      ...
      >
        {showDisabled ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-sky-50 via-blue-50/60 to-slate-50 dark:from-sky-950/40 dark:via-blue-950/30 dark:to-slate-950/20 flex items-center justify-center rounded">
            <style>{`
